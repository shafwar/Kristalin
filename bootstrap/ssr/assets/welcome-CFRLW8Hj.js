...
import { u as useKristalinTvGold, g as getBestSell1g, f as formatIdrAmount, b as useLcpSafeMicroMotion } from "./useKristalinTvGold-BJzELv25.js";
...
import { RefreshCw, TrendingUp, ExternalLink, Coins, ChevronRight } from "lucide-react";
...
function KristalinTvGoldCard({ className, onMouseEnter, onMouseLeave, hovered }) {
  ...
  const { market, brandPrices, loading, stale, lastUpdatedText, sourceName } = useKristalinTvGold(true);
  const { date, time, zone } = useJakartaClock(locale);
  const worldGram = (market == null ? void 0 : market.gold_idr_per_gram) ?? 145e4;
  const best = getBestSell1g(brandPrices == null ? void 0 : brandPrices.brands) || { brand: "Kisara Gold 24K", sell: 145e4 };
        ...
        /* @__PURE__ */ jsxs("div", { className: "gold-card-inner relative z-10 flex flex-col gap-3 p-4 sm:gap-4 sm:p-5 lg:h-full lg:min-h-0 lg:gap-0 lg:p-6", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex shrink-0 flex-col gap-2 sm:flex-row sm:items-start sm:justify-between sm:gap-3 lg:mb-3", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex min-w-0 flex-wrap items-center gap-1.5", children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "text-[10px] font-bold tracking-[0.14em] text-amber-300/95 uppercase sm:text-[11px]", children: isGoldOrg ? "GOLD.ORG · LIVE" : "KRISTALIN TV · LIVE" }),
              stale && lastUpdatedText && /* @__PURE__ */ jsx("span", { className: "shrink-0 rounded-full bg-amber-500/20 border border-amber-400/30 px-1.5 py-0.2 text-[8px] font-medium text-amber-200", children: lastUpdatedText })
            ] }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "gold-card-body flex shrink-0 flex-col gap-3 lg:min-h-0 lg:flex-1 lg:gap-0", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
                /* @__PURE__ */ jsx("span", { className: "inline-flex rounded-full bg-amber-400/90 px-2.5 py-0.5 text-[9px] font-bold tracking-wide text-slate-900 uppercase sm:text-[10px]", children: t("pages.welcome.gold_live.world_price") || "World Gold Price" }),
                loading && /* @__PURE__ */ jsx(RefreshCw, { className: "h-3 w-3 animate-spin text-amber-300/60" })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "gold-card-price-row mt-2 flex min-w-0 max-w-full flex-wrap items-baseline gap-x-1.5 gap-y-0.5", children: [
                ...
                /* @__PURE__ */ jsx("span", { className: "gold-card-price-unit shrink-0 font-semibold text-amber-200/85 tabular-nums", children: t("pages.welcome.gold_live.per_gram_short") || "/ gram" })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "mt-2 flex flex-wrap gap-1.5 sm:mt-3", children: [
                ...
                ] }) : /* @__PURE__ */ jsx("span", { className: "rounded-md border border-white/10 bg-white/5 px-2 py-0.5 text-[10px] tabular-nums text-slate-200", children: "USD 16.250" }),
                ...
                ] }) : /* @__PURE__ */ jsx("span", { className: "rounded-md border border-white/10 bg-white/5 px-2 py-0.5 text-[10px] tabular-nums text-slate-200", children: "SGD 12.150" })
              ] })
            ] }),
            best && /* @__PURE__ */ jsx("div", { className: "shrink-0 rounded-xl border border-amber-400/25 bg-gradient-to-r from-amber-500/10 to-yellow-500/5 p-2.5 sm:p-3 lg:mt-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-2", children: [
              /* @__PURE__ */ jsxs("div", { className: "min-w-0 flex-1", children: [
                /* @__PURE__ */ jsx("p", { className: "text-[10px] font-semibold tracking-wide text-amber-200/90 uppercase", children: t("pages.welcome.gold_live.best_sell") || "Best Physical Rate" }),
