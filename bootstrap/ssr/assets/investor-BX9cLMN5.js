...
function InvestorPage() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative flex min-h-screen flex-col overflow-x-hidden bg-white text-stone-900", children: [
    ...
    /* @__PURE__ */ jsxs("section", { className: "relative z-10 bg-stone-950 px-4 py-20 md:py-28 overflow-hidden text-white", children: [
      /* @__PURE__ */ jsxs("div", { className: "absolute inset-0 pointer-events-none opacity-25", children: [
        /* @__PURE__ */ jsx("div", { className: "absolute -top-32 -right-32 h-96 w-96 rounded-full bg-amber-500 blur-[130px]" }),
        /* @__PURE__ */ jsx("div", { className: "absolute -bottom-32 -left-32 h-96 w-96 rounded-full bg-amber-600 blur-[140px]" })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "relative z-10 mx-auto max-w-6xl", children: /* @__PURE__ */ jsx("div", { className: "rounded-3xl border border-stone-800 bg-stone-900/90 p-8 sm:p-12 lg:p-16 backdrop-blur-md shadow-2xl", children: /* @__PURE__ */ jsxs("div", { className: "grid gap-10 lg:grid-cols-12 lg:gap-12 items-center", children: [
        /* @__PURE__ */ jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxs("div", { className: "inline-flex items-center gap-2 rounded-full border border-amber-500/40 bg-amber-500/10 px-4 py-1 text-xs font-semibold uppercase tracking-widest text-amber-400", children: [
                /* @__PURE__ */ jsx(Sparkles, { className: "h-3.5 w-3.5" }),
                /* @__PURE__ */ jsx("span", { children: t("pages.investor.form_badge") || "Partnership & Institutional Inquiries" })
              ] }),
              /* @__PURE__ */ jsx("h2", { className: "text-3xl font-extrabold tracking-tight sm:text-4xl lg:text-5xl text-white", children: t("pages.investor.form_title") || "Mulai Kemitraan Strategis" }),
              /* @__PURE__ */ jsx("p", { className: "text-base sm:text-lg text-stone-300 leading-relaxed max-w-xl", children: t("pages.investor.form_subtitle") || "Diskusikan peluang kemitraan, aliansi rantai pasok, atau penjadwalan audiensi resmi bersama tim perwakilan institusional PT Kristalin Ekalestari." }),
              /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4 rounded-2xl border border-stone-800 bg-stone-950/60 p-4", children: [
                  /* @__PURE__ */ jsx("div", { className: "flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-amber-500/10 text-amber-400 border border-amber-500/20", children: /* @__PURE__ */ jsx(Mail, { className: "h-5 w-5" }) }),
                  /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("p", { className: "text-[11px] font-bold uppercase tracking-wider text-stone-400", children: t("pages.investor.contact_email_label") || "Email Institusional" }),
                    /* @__PURE__ */ jsx("p", { className: "text-sm font-semibold text-stone-200 mt-0.5", children: "investor@kristalin.co.id" })
                  ] })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4 rounded-2xl border border-stone-800 bg-stone-950/60 p-4", children: [
                  /* @__PURE__ */ jsx("div", { className: "flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-amber-500/10 text-amber-400 border border-amber-500/20", children: /* @__PURE__ */ jsx(Building2, { className: "h-5 w-5" }) }),
                  /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("p", { className: "text-[11px] font-bold uppercase tracking-wider text-stone-400", children: t("pages.investor.contact_hq_label") || "Kantor Pusat" }),
                    /* @__PURE__ */ jsx("p", { className: "text-sm font-semibold text-stone-200 mt-0.5", children: t("pages.investor.contact_hq_val") || "Jakarta Selatan, Indonesia" })
                  ] })
                ] })
              ] })
            ]
        ...
        /* @__PURE__ */ jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsx("h3", { className: "text-xl font-bold text-white", children: t("pages.investor.action_cta_title") || "Siap Mengembangkan Ekosistem?" }),
              /* @__PURE__ */ jsx("p", { className: "mt-2 text-sm text-stone-400 leading-relaxed", children: t("pages.investor.action_cta_desc") || "Kunjungi formulir kontak resmi kami untuk mengajukan proposal atau menjadwalkan diskusi kemitraan bersama manajemen." }),
              /* @__PURE__ */ jsx("div", { className: "mt-6", children: /* @__PURE__ */ jsxs(
                Link,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsx("span", { children: t("pages.investor.action_cta_btn") || "Hubungi Tim Kemitraan" }),
                    /* @__PURE__ */ jsx(ChevronRight, { className: "h-5 w-5 transition-transform group-hover:translate-x-1" })
                  ]
                }
              ) }),
              /* @__PURE__ */ jsx("p", { className: "mt-3.5 text-center text-[11px] text-stone-400", children: t("pages.investor.action_cta_note") || "* Kategori form otomatis diatur ke Partnership" })
            ]
          }
        )
      ] }) }) })
