...
function EsmdVerificationModal({ isOpen, onClose }) {
  ...
  const modalContent = /* @__PURE__ */ jsx(
    "div",
    {
      ...
      role: "dialog",
      "aria-modal": "true",
      children: /* @__PURE__ */ jsxs("div", { className: "relative my-auto flex max-h-[92dvh] sm:max-h-[88vh] w-full max-w-2xl flex-col overflow-hidden rounded-2xl sm:rounded-3xl border border-stone-200/90 bg-white text-stone-900 shadow-2xl ring-1 ring-black/5", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex-1 overflow-y-auto overscroll-contain p-4 sm:p-6 lg:p-7", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3 sm:gap-4 border-b border-stone-100 pb-4 sm:pb-5", children: [
            /* @__PURE__ */ jsx("div", { className: "flex h-10 w-10 sm:h-13 sm:w-13 shrink-0 items-center justify-center rounded-xl sm:rounded-2xl border border-amber-200 bg-amber-50 text-amber-700 shadow-sm", children: /* @__PURE__ */ jsx(Shield, { className: "h-5 w-5 sm:h-6 sm:w-6", strokeWidth: 2.2 }) }),
            /* @__PURE__ */ jsxs("div", { className: "pr-6 sm:pr-8", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-1.5 sm:gap-2", children: [
                /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1 sm:gap-1.5 rounded-full bg-emerald-50 border border-emerald-200/80 px-2 py-0.5 text-[10px] sm:text-[11px] font-bold text-emerald-800 tracking-wide uppercase", children: [
                  /* @__PURE__ */ jsx("span", { className: "h-1.5 w-1.5 rounded-full bg-emerald-500 animate-pulse" }),
                  "Verified Clean & Clear"
                ] }),
                /* @__PURE__ */ jsx("span", { className: "text-[10px] sm:text-[11px] font-semibold text-stone-500 uppercase tracking-wider", children: "MODI Minerba ESDM RI" })
              ] }),
              /* @__PURE__ */ jsx("h3", { className: "mt-1 text-base sm:text-xl lg:text-2xl font-bold tracking-tight text-stone-900 leading-snug", children: t("pages.esdm_verification.modal_title") || "Verifikasi Legalitas & Kepatuhan IUP OP" }),
              /* @__PURE__ */ jsx("p", { className: "mt-0.5 text-[11px] sm:text-xs text-stone-500 leading-relaxed", children: t("pages.esdm_verification.modal_subtitle") || "Transparansi Izin Usaha Pertambangan Resmi PT Kristalin Ekalestari" })
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "mt-4 divide-y divide-stone-200/70 rounded-xl sm:rounded-2xl border border-stone-200/80 bg-stone-50/70 overflow-hidden shadow-inner", children: [
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 divide-y sm:divide-y-0 sm:divide-x divide-stone-200/70", children: [
              /* @__PURE__ */ jsxs("div", { className: "p-3 sm:p-4", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 text-stone-500", children: [
                  /* @__PURE__ */ jsx(Landmark, { className: "h-3 w-3 sm:h-3.5 sm:w-3.5 text-amber-600" }),
                ...
                /* @__PURE__ */ jsx("p", { className: "mt-0.5 sm:mt-1 text-xs sm:text-sm font-bold text-stone-900", children: t("pages.esdm_verification.company_name_val") || "PT Kristalin Ekalestari" })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "p-3 sm:p-4 bg-amber-50/30", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 text-stone-500", children: [
                  /* @__PURE__ */ jsx(FileCheck, { className: "h-3 w-3 sm:h-3.5 sm:w-3.5 text-amber-600" }),
                ...
                /* @__PURE__ */ jsx("p", { className: "mt-0.5 sm:mt-1 text-xs sm:text-sm font-bold text-amber-800", children: t("pages.esdm_verification.permit_type_val") || "IUP Operasi Produksi (IUP OP)" })
              ] })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 divide-y sm:divide-y-0 sm:divide-x divide-stone-200/70", children: [
              /* @__PURE__ */ jsxs("div", { className: "p-3 sm:p-4", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 text-stone-500", children: [
                  /* @__PURE__ */ jsx(Award, { className: "h-3 w-3 sm:h-3.5 sm:w-3.5 text-amber-600" }),
                ...
                /* @__PURE__ */ jsx("p", { className: "mt-0.5 sm:mt-1 font-mono text-xs sm:text-sm font-bold text-stone-900", children: /* @__PURE__ */ jsx("span", { className: "rounded border border-amber-300/80 bg-amber-100/70 px-1.5 py-0.5 text-amber-900", children: t("pages.esdm_verification.decree_number_val") || "561/2021/DESDM" }) })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "p-3 sm:p-4", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 text-stone-500", children: [
                  /* @__PURE__ */ jsx(CheckCircle2, { className: "h-3 w-3 sm:h-3.5 sm:w-3.5 text-emerald-600" }),
                ...
                /* @__PURE__ */ jsx("p", { className: "mt-0.5 sm:mt-1 text-xs sm:text-sm font-semibold text-stone-900", children: t("pages.esdm_verification.validity_val") || "2020 – 2030 (10 Tahun Operasi)" })
              ] })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 divide-y sm:divide-y-0 sm:divide-x divide-stone-200/70", children: [
              /* @__PURE__ */ jsxs("div", { className: "p-3 sm:p-4", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 text-stone-500", children: [
                  /* @__PURE__ */ jsx(ShieldCheck, { className: "h-3 w-3 sm:h-3.5 sm:w-3.5 text-amber-600" }),
                ...
                /* @__PURE__ */ jsx("p", { className: "mt-0.5 sm:mt-1 text-xs sm:text-sm font-semibold text-stone-900", children: t("pages.esdm_verification.commodity_val") || "Emas Primer (DMP) & Mineral Ikutan" })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "p-3 sm:p-4", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 text-stone-500", children: [
                  /* @__PURE__ */ jsx(MapPin, { className: "h-3 w-3 sm:h-3.5 sm:w-3.5 text-amber-600" }),
                ...
                /* @__PURE__ */ jsx("p", { className: "mt-0.5 sm:mt-1 text-xs sm:text-sm font-semibold text-stone-900", children: t("pages.esdm_verification.location_val") || "Distrik Topo, Kab. Nabire, Papua (198 Ha)" })
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "mt-3 text-[10px] sm:text-[11px] leading-relaxed text-stone-500", children: t("pages.esdm_verification.disclaimer") || "Seluruh data legalitas di atas dapat diverifikasi langsung melalui database publik Kementerian Energi dan Sumber Daya Mineral (ESDM) Republik Indonesia." })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "shrink-0 border-t border-stone-100 bg-stone-50/90 backdrop-blur-sm p-3.5 sm:p-5 flex flex-col-reverse sm:flex-row items-stretch sm:items-center sm:justify-between gap-2.5", children: [
          /* @__PURE__ */ jsx(
            "button",
            {
              type: "button",
