...
`
  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative mx-auto my-8 sm:my-12 w-full max-w-4xl overflow-hidden rounded-2xl sm:rounded-3xl border border-amber-500/30 bg-[#0f172a] p-6 text-white shadow-xl sm:p-10 ring-1 ring-white/10", children: [
    /* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute -left-16 -top-16 h-48 w-48 rounded-full bg-amber-500/10 blur-[60px]" }),
    /* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute -bottom-16 -right-16 h-48 w-48 rounded-full bg-amber-600/10 blur-[60px]" }),
    /* @__PURE__ */ jsxs("div", { className: "relative z-10 flex flex-col items-start justify-between gap-4 border-b border-white/10 pb-6 md:flex-row md:items-center", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsx("h3", { className: "mt-1 text-xl sm:text-2xl lg:text-3xl font-bold text-white tracking-tight", children: t("pages.b2c.calculator.title") || "Kalkulator Investasi Logam Mulia" }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative z-10 mt-6 sm:mt-8 grid grid-cols-1 gap-6 sm:gap-8 lg:grid-cols-12", children: [
      /* @__PURE__ */ jsxs("div", { className: "space-y-5 sm:space-y-6 lg:col-span-7", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "mb-2.5 block text-xs font-semibold tracking-wider text-stone-300 uppercase", children: t("pages.b2c.calculator.select_weight") || "Pilih Gramatur Emas" }),
          /* @__PURE__ */ jsx("div", { className: "grid grid-cols-4 gap-2 sm:gap-3", children: GRAM_PRESETS.map((grams) => {
            ...
            return /* @__PURE__ */ jsxs(
              "button",
              {
                ...
                className: `group relative flex flex-col items-center justify-center rounded-xl border p-2.5 sm:p-3 font-semibold transition-all duration-200 active:scale-95 cursor-pointer ${active ? "border-amber-400 bg-amber-500/20 text-white shadow-md ring-1 ring-amber-400" : "border-white/10 bg-white/5 text-stone-300 hover:border-white/20 hover:bg-white/10"}`,
                children: [
                  /* @__PURE__ */ jsx("span", { className: "text-sm font-bold sm:text-base", children: grams >= 1e3 ? `${grams / 1e3} kg` : `${grams}g` }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 rounded-xl sm:rounded-2xl border border-emerald-500/20 bg-emerald-950/20 p-3.5 text-xs text-emerald-300", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col justify-between rounded-xl sm:rounded-2xl border border-white/15 bg-gradient-to-br from-white/10 via-white/5 to-transparent p-5 sm:p-6 backdrop-blur-md lg:col-span-5", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
            ...
            /* @__PURE__ */ jsxs("span", { className: "rounded-full bg-amber-400/20 px-2.5 py-0.5 text-[10px] font-bold text-amber-300", children: [
              activeGrams,
              " Gram"
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "mt-3", children: [
            /* @__PURE__ */ jsx("p", { className: "font-mono text-2xl sm:text-3xl lg:text-4xl font-extrabold tracking-tight text-amber-300", children: formatIdrAmount(estimatedTotal) }),
          ...
          /* @__PURE__ */ jsx("div", { className: "mt-5 border-t border-white/10 pt-3.5", children: /* @__PURE__ */ jsx("p", { className: "text-[10px] leading-relaxed text-stone-400", children: t("pages.b2c.calculator.pricing_note") || "* Harga bersifat indikatif mengikuti update pasar live. Kuotasi final dikunci saat verifikasi administrasi." }) })
        ] }),
    ...
    isRfqModalOpen && mounted && createPortal(
      /* @__PURE__ */ jsx(
        "div",
        {
          ...
          role: "dialog",
          "aria-modal": "true",
          children: /* @__PURE__ */ jsxs("div", { className: "relative my-auto w-full max-w-lg overflow-hidden rounded-2xl sm:rounded-3xl border border-amber-500/30 bg-[#0f172a] p-6 text-white shadow-2xl sm:p-8 ring-1 ring-white/10", children: [
            /* @__PURE__ */ jsx(
              "button",
              {
                type: "button",
            ...
            rfqStatus === "success" ? /* @__PURE__ */ jsxs("div", { className: "py-6 text-center", children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "mt-2 text-xs sm:text-sm text-stone-300", children: t("pages.b2c.calculator.success_desc") || "Terima kasih. Tim penjualan Kristalin Ekalestari akan segera mengirimkan konfirmasi kuotasi resmi ke email Anda." }),
              /* @__PURE__ */ jsx(
                "button",
                {
                  type: "button",
