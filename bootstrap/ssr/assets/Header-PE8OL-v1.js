  ...
  if (minimal) {
    return /* @__PURE__ */ jsxs(Fragment, { children: [
      ...
      /* @__PURE__ */ jsxs("footer", { className: `relative w-full bg-stone-950 py-3 sm:py-4 text-stone-300 overflow-hidden shrink-0 border-t border-white/5 ${className}`, style: { zIndex: 100 }, children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "container mx-auto px-6 md:px-12 lg:px-16 relative z-10", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col md:flex-row items-center justify-between gap-3 md:gap-4", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap justify-center gap-x-4 md:gap-x-6 gap-y-2 text-[11px] sm:text-sm text-stone-400 font-medium tracking-wide order-1 md:order-2", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "text-stone-500 md:text-stone-400 text-[10px] sm:text-sm text-center md:text-left font-medium tracking-wide flex items-center justify-center gap-2 order-2 md:order-1 mt-1 md:mt-0", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-6 md:px-12 lg:px-16 relative z-10", children: [
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-16", children: [
          /* @__PURE__ */ jsxs("div", { className: "lg:col-span-5 flex flex-col items-start", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-stone-400 text-sm md:text-base leading-relaxed max-w-md mb-8", children: "Trusted partner in integrated gold exploration, refining, and trading since 1989. Committed to sustainable operations and community development across Papua and Indonesia." }),
...
function Header({ sticky = false, transparent = false }) {
  ...
  const navigationItems = [
    ...
    {
      label: "Investor",
      // Removed missing nav translation to force 'Investor'
