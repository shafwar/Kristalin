...
import { ChevronDown, ExternalLink, Coins, Plus, Info, Award, ShieldCheck, Truck, RotateCcw, RefreshCw, ChevronRight, ArrowDownRight, Sparkles, Building2, FileText, Scale } from "lucide-react";
...
function GoldBullionCalculator() {
  ...
  return /* @__PURE__ */ jsx("div", { className: "w-full", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 gap-8 lg:grid-cols-12 lg:gap-12 items-start", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "lg:col-span-5 lg:sticky lg:top-24", children: /* @__PURE__ */ jsxs("div", { className: "rounded-3xl border border-stone-200/90 bg-white p-6 sm:p-7 shadow-xl shadow-stone-200/50 ring-1 ring-stone-900/5", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "my-5", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "mt-3 flex items-baseline gap-1.5 flex-nowrap overflow-hidden", children: [
          ...
          /* @__PURE__ */ jsx("span", { className: "font-mono text-3xl sm:text-4xl font-extrabold tracking-tight text-stone-950 truncate", children: formatIdrAmount(estimatedTotal) })
        ] }),
