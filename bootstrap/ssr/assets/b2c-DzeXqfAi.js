...
import { ChevronDown, ExternalLink, Sparkles, ChevronRight, Coins, Check, X, Plus, Info, RefreshCw, ShieldCheck, Award, Truck, RotateCcw, ArrowDownRight, Building2, FileText, Scale } from "lucide-react";
...
function GoldBullionCalculator() {
  ...
  return /* @__PURE__ */ jsx("div", { className: "w-full", children: /* @__PURE__ */ jsxs("div", { className: "relative overflow-hidden rounded-3xl border border-stone-200/90 bg-gradient-to-b from-white via-white to-stone-50/70 p-5 sm:p-8 lg:p-10 shadow-xl shadow-stone-200/60 ring-1 ring-stone-900/5", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative z-10 mb-8 sm:mb-10 text-center sm:text-left", children: [
      /* @__PURE__ */ jsxs("div", { className: "inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-amber-500/15 via-amber-400/20 to-yellow-500/15 border border-amber-400/40 px-3.5 py-1.5 text-xs font-bold text-amber-950 tracking-wide shadow-2xs", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "block lg:hidden mb-6 relative z-10", children: /* @__PURE__ */ jsxs("div", { className: "rounded-2xl border border-amber-300/90 bg-gradient-to-br from-amber-500/15 via-white to-amber-500/5 p-4.5 sm:p-5 shadow-lg shadow-amber-500/10 ring-1 ring-amber-400/30", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between border-b border-amber-200/80 pb-3", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsx("span", { className: `h-2 w-2 rounded-full ${stale ? "bg-amber-400" : "animate-pulse bg-emerald-500"}` }),
          /* @__PURE__ */ jsx("span", { className: "text-[11px] font-bold text-stone-700 uppercase tracking-wider", children: t("pages.b2c.calculator.live_price_per_gram") || "Harga Acuan" }),
          lastUpdatedText && /* @__PURE__ */ jsx("span", { className: "rounded-md bg-amber-100/90 border border-amber-300/50 px-1.5 py-0.5 text-[9px] font-bold text-amber-900", children: lastUpdatedText })
        ] }),
        /* @__PURE__ */ jsxs("p", { className: "font-sans text-sm font-black text-stone-950", children: [
          formatIdr(basePricePerGram),
          " ",
          /* @__PURE__ */ jsxs("span", { className: "text-[10px] font-medium text-stone-500", children: [
            "/",
            unitGram
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "my-3.5", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "mt-2 flex items-baseline gap-1", children: [
          ...
          /* @__PURE__ */ jsx("span", { className: "font-sans text-2xl sm:text-3xl font-black tracking-tight text-stone-950", children: formatIdrAmount(estimatedTotal) })
        ] }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative z-10 grid grid-cols-1 gap-8 lg:grid-cols-12 lg:gap-10 items-start", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col space-y-6 lg:col-span-7", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsxs("div", { className: "mb-3 flex items-center justify-between", children: [
            ...
            /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1.5 rounded-full border border-amber-300/80 bg-amber-50 px-3 py-0.5 text-xs font-bold text-amber-950 shadow-2xs", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "grid grid-cols-4 gap-2.5 sm:gap-3.5", children: PRESETS.map(({ grams, tag }) => {
            ...
            return /* @__PURE__ */ jsxs(
              "button",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx("span", { className: `text-base sm:text-xl font-extrabold tracking-tight ${active ? "text-stone-950" : "text-stone-900 group-hover:text-amber-950"}`, children: grams >= 1e3 ? `${grams / 1e3} kg` : `${grams}g` }),
                  /* @__PURE__ */ jsx("span", { className: `text-[10px] sm:text-xs mt-0.5 font-medium ${active ? "text-amber-900 font-bold" : "text-stone-500"}`, children: grams >= 1e3 ? `1.000 ${unitGram}` : `${grams} ${unitGram}` })
                ]
              },
              grams
            );
        ...
        /* @__PURE__ */ jsxs("div", { className: "rounded-2xl border border-stone-200/90 bg-gradient-to-b from-stone-50/70 to-white p-4 sm:p-5 shadow-sm", children: [
            ...
            isCustom ? /* @__PURE__ */ jsxs(
              "button",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx("span", { children: "Reset ke Preset" })
                ]
              }
            ) : /* @__PURE__ */ jsx("span", { className: "text-[11px] text-stone-400", children: "Ketik berat sesuai kebutuhan" })
          ] }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3 rounded-2xl bg-amber-50/80 border border-amber-200/90 p-3.5 sm:p-4 text-xs text-amber-950 shadow-2xs", children: [
          /* @__PURE__ */ jsx(Info, { className: "h-4 w-4 shrink-0 text-amber-700 mt-0.5" }),
          /* @__PURE__ */ jsxs("p", { className: "leading-relaxed text-[11px] sm:text-xs text-amber-950", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "hidden lg:block lg:col-span-5 lg:sticky lg:top-24", children: /* @__PURE__ */ jsxs("div", { className: "rounded-3xl border border-amber-300/80 bg-gradient-to-b from-amber-500/10 via-white to-white p-6 sm:p-7 shadow-xl shadow-amber-500/10 ring-1 ring-amber-400/20", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between border-b border-stone-200/80 pb-4", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxs("p", { className: "mt-1 font-sans text-base sm:text-lg font-black text-stone-900", children: [
              formatIdr(basePricePerGram),
              " ",
    ...
    /* @__PURE__ */ jsx("div", { className: "relative z-10 mt-10 sm:mt-12 pt-8 border-t border-stone-200/80", children: /* @__PURE__ */ jsx("div", { className: "mx-auto max-w-5xl", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-3 sm:grid-cols-4 sm:gap-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center rounded-2xl border border-stone-200/90 bg-white p-4.5 text-center shadow-2xs transition-all duration-200 hover:border-amber-300 hover:-translate-y-0.5 hover:shadow-md", children: [
        /* @__PURE__ */ jsx("div", { className: "mb-2.5 flex h-11 w-11 items-center justify-center rounded-2xl bg-amber-100/90 text-amber-800 border border-amber-200/80 shadow-2xs", children: /* @__PURE__ */ jsx(Award, { className: "h-5 w-5" }) }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center rounded-2xl border border-stone-200/90 bg-white p-4.5 text-center shadow-2xs transition-all duration-200 hover:border-emerald-300 hover:-translate-y-0.5 hover:shadow-md", children: [
        /* @__PURE__ */ jsx("div", { className: "mb-2.5 flex h-11 w-11 items-center justify-center rounded-2xl bg-emerald-100/90 text-emerald-800 border border-emerald-200/80 shadow-2xs", children: /* @__PURE__ */ jsx(ShieldCheck, { className: "h-5 w-5" }) }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center rounded-2xl border border-stone-200/90 bg-white p-4.5 text-center shadow-2xs transition-all duration-200 hover:border-blue-300 hover:-translate-y-0.5 hover:shadow-md", children: [
        /* @__PURE__ */ jsx("div", { className: "mb-2.5 flex h-11 w-11 items-center justify-center rounded-2xl bg-blue-100/90 text-blue-800 border border-blue-200/80 shadow-2xs", children: /* @__PURE__ */ jsx(Truck, { className: "h-5 w-5" }) }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center rounded-2xl border border-stone-200/90 bg-white p-4.5 text-center shadow-2xs transition-all duration-200 hover:border-amber-300 hover:-translate-y-0.5 hover:shadow-md", children: [
        /* @__PURE__ */ jsx("div", { className: "mb-2.5 flex h-11 w-11 items-center justify-center rounded-2xl bg-amber-100/90 text-amber-800 border border-amber-200/80 shadow-2xs", children: /* @__PURE__ */ jsx(RotateCcw, { className: "h-5 w-5" }) }),
