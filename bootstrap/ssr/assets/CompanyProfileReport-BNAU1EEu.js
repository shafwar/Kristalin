...
import { Loader2, ArrowLeft, Printer, ShieldCheck, HeartHandshake, Award, TrendingUp, Eye, Target, History, Gem, Leaf, Users, Factory, Smartphone, Pickaxe, Store, GraduationCap, MapPin, Mail, Phone } from "lucide-react";
...
function CompanyProfileReport() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-stone-100 py-0 md:py-8 print:bg-white print:py-0", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "fixed bottom-0 left-0 right-0 z-50 flex items-center justify-between gap-2 border-t border-stone-200 bg-white/95 px-3 py-2.5 backdrop-blur-sm print:hidden md:bottom-auto md:left-auto md:right-8 md:top-8 md:border-0 md:bg-transparent md:backdrop-blur-none md:gap-3 md:justify-end md:px-0 md:py-0", children: [
      /* @__PURE__ */ jsx(
        "a",
        {
          href: "/investor",
      ...
      /* @__PURE__ */ jsxs(
        "a",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("span", { children: t("pages.company_profile.download_btn") || "Unduh PDF Asli" })
          ]
        }
      ),
      /* @__PURE__ */ jsxs(
        "button",
        {
          ...
          children: [
            isPrinting ? /* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4 animate-spin" }) : /* @__PURE__ */ jsx(Printer, { className: "h-4 w-4" }),
            /* @__PURE__ */ jsx("span", { children: isPrinting ? printLabel : t("pages.company_profile.print_btn") || "Cetak / Print" })
          ]
        }
      )
    ] }),
