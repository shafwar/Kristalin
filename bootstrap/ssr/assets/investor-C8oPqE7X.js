      ...
      /* @__PURE__ */ jsx("div", { className: "relative z-10 mx-auto max-w-6xl", children: /* @__PURE__ */ jsx("div", { className: "rounded-3xl border border-stone-800 bg-stone-900/90 p-8 sm:p-12 lg:p-16 backdrop-blur-md shadow-2xl", children: /* @__PURE__ */ jsxs("div", { className: "grid gap-10 lg:grid-cols-12 lg:gap-12 items-center", children: [
        ...
        /* @__PURE__ */ jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsx("h3", { className: "text-xl font-bold text-white", children: "Siap Mengembangkan Ekosistem?" }),
              /* @__PURE__ */ jsx("p", { className: "mt-2 text-sm text-stone-400 leading-relaxed", children: "Kunjungi formulir kontak resmi kami untuk mengajukan proposal atau menjadwalkan diskusi kemitraan bersama manajemen." }),
              /* @__PURE__ */ jsx("div", { className: "mt-6", children: /* @__PURE__ */ jsxs(
                Link,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsx("span", { children: "Hubungi Tim Kemitraan" }),
                    /* @__PURE__ */ jsx(ChevronRight, { className: "h-5 w-5 transition-transform group-hover:translate-x-1" })
                  ]
                }
              ) }),
              /* @__PURE__ */ jsxs("p", { className: "mt-3.5 text-center text-[11px] text-stone-400", children: [
                "* Kategori form otomatis diatur ke ",
