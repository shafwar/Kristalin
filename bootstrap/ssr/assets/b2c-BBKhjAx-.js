...
import { ChevronDown, ExternalLink, Sparkles, Tv, Check, X, ChevronRight, ShieldCheck, Coins, RefreshCw, Award, Truck, RotateCcw, ArrowDownRight, Building2, FileText, Scale } from "lucide-react";
...
function GoldBullionCalculator() {
  ...
  return /* @__PURE__ */ jsx("div", { className: "w-full", children: /* @__PURE__ */ jsxs("div", { className: "relative overflow-hidden rounded-3xl border border-stone-200/90 bg-gradient-to-b from-white via-white to-stone-50/70 p-5 sm:p-8 lg:p-10 shadow-2xl shadow-stone-200/60 ring-1 ring-stone-900/5", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "rounded-2xl border border-amber-300/90 bg-gradient-to-br from-amber-500/15 via-white to-amber-500/5 p-4 sm:p-5 shadow-lg shadow-amber-500/10 ring-1 ring-amber-400/30", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between border-b border-amber-200/70 pb-3", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 min-w-0", children: [
            /* @__PURE__ */ jsx("span", { className: `h-2.5 w-2.5 shrink-0 rounded-full ${stale ? "bg-amber-400" : "animate-pulse bg-emerald-500"}` }),
            /* @__PURE__ */ jsxs("div", { className: "flex flex-col", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5", children: [
                /* @__PURE__ */ jsx(Tv, { className: "h-3.5 w-3.5 text-amber-700 shrink-0" }),
                /* @__PURE__ */ jsx("span", { className: "text-xs font-black text-stone-900 tracking-wide uppercase", children: "Kristalin TV Live" })
              ] }),
              lastUpdatedText && /* @__PURE__ */ jsx("span", { className: "text-[10px] text-stone-500 font-medium", children: lastUpdatedText })
            ] })
          ] }),
          /* @__PURE__ */ jsxs(
            "a",
            {
              ...
              children: [
                /* @__PURE__ */ jsx("span", { children: "Buka TV" }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "mt-3 flex items-center justify-between", children: [
          /* @__PURE__ */ jsx("span", { className: "text-[11px] font-bold text-stone-500 uppercase tracking-wider", children: t("pages.b2c.calculator.live_price_per_gram") || "Harga Acuan Pasar" }),
          /* @__PURE__ */ jsxs("span", { className: "font-sans text-sm sm:text-base font-black text-stone-900", children: [
            formatIdr(basePricePerGram),
            " ",
            /* @__PURE__ */ jsxs("span", { className: "text-[10px] font-semibold text-stone-500", children: [
              "/",
              unitGram
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "mt-4 pt-3 border-t border-amber-200/50", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsx("span", { className: "text-[11px] font-bold tracking-wider text-stone-600 uppercase", children: t("pages.b2c.calculator.estimated_total") || "Estimasi Total" }),
            /* @__PURE__ */ jsx("span", { className: "rounded-full bg-amber-400/30 border border-amber-500/50 px-2.5 py-0.5 text-xs font-black text-amber-950", children: formattedWeightLabel })
          ] }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "hidden lg:grid lg:grid-cols-12 lg:gap-8 items-stretch relative z-10", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "lg:col-span-5 flex flex-col", children: /* @__PURE__ */ jsxs("div", { className: "h-full flex flex-col justify-between rounded-3xl border border-amber-300/90 bg-gradient-to-b from-amber-500/10 via-white to-white p-7 sm:p-8 shadow-xl shadow-amber-500/10 ring-1 ring-amber-400/20", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col space-y-6", children: [
          /* @__PURE__ */ jsxs("div", { className: "rounded-2xl border border-amber-300/90 bg-gradient-to-br from-amber-500/20 via-amber-50/70 to-yellow-500/10 p-5 shadow-sm", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsx("span", { className: `h-2.5 w-2.5 rounded-full ${stale ? "bg-amber-400" : "animate-pulse bg-emerald-500"}` }),
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5", children: [
                  /* @__PURE__ */ jsx(Tv, { className: "h-4 w-4 text-amber-800" }),
                  /* @__PURE__ */ jsx("span", { className: "text-xs font-black tracking-wider text-stone-900 uppercase", children: "Kristalin TV Live Feed" })
                ] })
              ] }),
              /* @__PURE__ */ jsx(
                "button",
            ...
            /* @__PURE__ */ jsxs("div", { className: "mt-3 flex items-baseline justify-between border-t border-amber-200/70 pt-3", children: [
              /* @__PURE__ */ jsx("div", { className: "text-[11px] font-bold text-stone-600 uppercase tracking-wide", children: t("pages.b2c.calculator.live_price_per_gram") || "Harga Acuan Pasar" }),
              /* @__PURE__ */ jsxs("div", { className: "font-sans text-xl font-black text-stone-950", children: [
                formatIdr(basePricePerGram),
                " ",
            ...
            /* @__PURE__ */ jsxs("div", { className: "mt-3 pt-2.5 border-t border-amber-200/60 flex items-center justify-between", children: [
              /* @__PURE__ */ jsx("span", { className: "text-[10px] text-stone-500 font-medium", children: lastUpdatedText || "Data diperbarui real-time" }),
              /* @__PURE__ */ jsxs(
                "a",
                {
                  href: "https://livegold-kristalintv.com/",
                  ...
                  children: [
                    /* @__PURE__ */ jsx("span", { children: "Buka Live Kristalin TV" }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "rounded-2xl border border-stone-200/80 bg-stone-50/60 p-5 shadow-2xs", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
