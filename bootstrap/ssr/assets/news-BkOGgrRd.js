...
import "react-dom";
const getTranslatedMonth = (monthId, t) => {
  const monthMap = {
...
const getYearFromMonthId = (monthId) => {
  ...
  return /^\d{4}$/.test(last) ? last : (/* @__PURE__ */ new Date()).getFullYear().toString();
};
const getTranslatedCategoryTitle = (categoryId, t) => {
  return t(`news_archive.categories.${categoryId}`);
};
const getTranslatedArticleTitle = (articleId, t) => {
  const articleKeyMap = {
...
const getTranslatedArticleExcerpt = (articleId, t) => {
  const articleKeyMap = {
    "feb-4": "feb_house_construction_1",
    "feb-7": "feb_sembako_distribution",
    "feb-8": "feb_sembako_distribution_2",
...
const normalizeNewsImages = (data) => data.map((month) => ({
  ...month,
...
const newsData = normalizeNewsImages([
  {
    month: "FEBRUARI",
        ...
        newsItems: [
          {
            ...
            fullContent: {
              ...
              source: "Fajarpos.com",
              sourceUrl: "https://www.fajarpos.com/04/02/2025/awal-tahun-2025-pt-kristalin-ekalestari-salurkan-506-paket-sembako-untuk-warga-nifasi/",
              image: "/506paket1.jpg",
              content: `
                                <div class="space-y-8">
                                    <!-- Opening Story -->
          ...
          },
          {
            ...
            fullContent: {
              ...
              source: "iNews.id",
              sourceUrl: "https://jayapura.inews.id/read/552327/506-paket-sembako-disalurkan-pt-kristalin-ekalestari-untuk-warga-nifasi",
          ...
          },
          {
            ...
            fullContent: {
              ...
              sourceUrl: "https://wartakota.tribunnews.com/2025/02/03/awal-tahun-2025-kristalin-ekalestari-salurkan-506-paket-sembako-untuk-warga-nabire-papua-tengah",
              image: "/506paket3.jpg",
              content: `
                                <div class="space-y-8">
                                    <!-- Opening Story -->
        ...
        newsItems: [
          {
            ...
            fullContent: {
              ...
              author: "Tim Redaksi",
              source: "AKURAT.CO",
              sourceUrl: "https://www.akurat.co/daerah/833630/ketua-dewan-adat-7-wilayah-sub-suku-meyah-terima-mobil-operasional-untuk-kegiatan-masyarakat",
        ...
        newsItems: [
          {
            ...
            date: "8 Jul 2026",
            url: "/news/jul26-1",
            excerpt: "Investasi PT Kristalin Ekalestari memberikan manfaat nyata bagi pembangunan dan penggerak ekonomi masyarakat Desa Nifasi, didukung penuh oleh para tokoh adat setempat.",
            fullContent: {
              title: "Investasi PT Kristalin Ekalestari Berdampak Baik Pembangunan dan Ekonomi Warga",
              date: "8 Juli 2026",
              author: "Tim Redaksi",
              source: "ARASVARA.ID",
              sourceUrl: "https://arasvara.id/news/2026/07/08/investasi-pt-kristalin-ekalestari-berdampak-baik-pembangunan-dan-ekonomi-warga",
        ...
        newsItems: [
          ...
          },
          {
            ...
            fullContent: {
              ...
              source: "SindoNews",
              sourceUrl: "https://daerah.sindonews.com/read/1545101/174/peduli-nelayan-warga-desa-nifasi-papua-dapat-rumah-baru-1742400230",
          ...
          },
          {
            ...
            fullContent: {
              ...
              author: "SM Said",
              source: "iNews Jayapura",
              sourceUrl: "https://jayapura.inews.id/read/571890/haru-nelayan-laut-desa-nifasi-dapat-rumah-baru?utm_medium=sosmed&utm_source=whatsapp",
          ...
          },
          {
            ...
            fullContent: {
              ...
              author: "Rizki",
              source: "Viva.co.id",
              sourceUrl: "https://banten.viva.co.id/berita/5886-csr-pt-kristalin-ekalestari-nelayan-desa-nifasi-akhirnya-miliki-rumah-layak",
        ...
        newsItems: [
          {
            ...
            fullContent: {
              ...
              author: "Deny Irwanto",
              source: "MetroTV News",
              sourceUrl: "https://www.metrotvnews.com/read/koGCdw0A-dana-pendidikan-sejumlah-pelajar-sma-di-desa-nifasi-nabire-terjamin-hingga-lulus",
          ...
          },
          {
            ...
            fullContent: {
              ...
              author: "Tim Redaksi",
              source: "Warta Ekonomi",
              sourceUrl: "https://wartaekonomi.co.id/read572556/kristalin-ekalestari-biayai-pendidikan-8-pelajar-sman-6-nabire-lewat-program-csr",
        ...
        newsItems: [
          {
            ...
            fullContent: {
              ...
              author: "Tim Redaksi",
              source: "TerasMedia",
              sourceUrl: "https://terasmedia.co/hukum-dan-kriminal/30710/pt-kristalin-ekalestari-serahkan-rumah-baru-ibu-rumah-tangga-di-desa-nifasi/",
        ...
        newsItems: [
          {
            ...
            fullContent: {
              ...
              author: "Tim Redaksi",
              source: "SindoNews",
              sourceUrl: "https://daerah.sindonews.com/read/1590209/174/ratusan-warga-kampung-mamai-papua-terima-bantuan-paket-sembako-1751972838/5",
          ...
          },
          {
            ...
            fullContent: {
              ...
              author: "Tim Redaksi",
              source: "IPOL.id",
              sourceUrl: "https://ipol.id/2025/07/pt-kristalin-ekalestari-salurkan-506-paket-sembako-50-persen-diantaranya-diterima-janda-lansia/",
          ...
          },
          {
            ...
            fullContent: {
              ...
              author: "Tim Redaksi",
              source: "HarianTerbit",
              sourceUrl: "https://www.harianterbit.com/megapolitan/27415500844/kehadiran-pt-kristalin-ekalestari-bukti-kontribusi-warga-desa-nifasi",
        ...
        newsItems: [
          {
            ...
            fullContent: {
              ...
              author: "Tim Redaksi",
              source: "WartaKota",
              sourceUrl: "https://wartakota.tribunnews.com/2025/07/08/boyong-ke-jakarta-pt-kristalin-ekalestari-serahkan-bantuan-kepada-warga-distrik-makimi-papua",
        ...
        newsItems: [
          {
            ...
            fullContent: {
              ...
              author: "Tim Redaksi",
              source: "Viva.co.id",
              sourceUrl: "https://banten.viva.co.id/berita/7320-kado-hut-ri-ke-80-buruh-harian-lepas-desa-nifasi-dapat-rumah-dari-pt-kristalin-ekalestari?page=2",
              image: "/agus1.jpg",
              content: `
                                <div class="space-y-8">
                                    <div class="rounded-2xl border border-blue-100 bg-gradient-to-r from-blue-50 to-cyan-50 p-6">
        ...
        newsItems: [
          {
            ...
            fullContent: {
              ...
              author: "Tim Redaksi",
              source: "Jawa Pos",
              sourceUrl: "https://www.jawapos.com/berita-sekitar-anda/016510236/bagikan-506-paket-sembako-untuk-janda-lansia-dan-tempat-ibadah-di-nabire",
              image: "/agus4.webp",
              content: `
                                <div class="space-y-8">
                                    <!-- Opening Story -->
          ...
          },
          {
            ...
            fullContent: {
              ...
              sourceUrl: "https://www.harianterbit.com/humaniora/27415831709/buktikan-kepedulian-pt-kristalin-ekalestari-bagikan-ratusan-sembako-tiap-bulan-di-papua-tengah",
              image: "/agus5.webp",
              content: `
                                <div class="space-y-8">
                                    <!-- Opening Story -->
          ...
          },
          {
            ...
            fullContent: {
              ...
              author: "Tim Redaksi",
              source: "Warta Kota",
              sourceUrl: "https://wartakota.tribunnews.com/news/865880/kristalin-ekalestari-salurkan-ratusan-paket-sembako-kepada-lansia-dan-tempat-ibadah",
              image: "/agus7.jpg",
              content: `
                                <div class="space-y-8">
                                    <!-- Opening Story -->
          ...
          },
          {
            ...
            fullContent: {
              ...
              author: "Tim Redaksi",
              source: "Harian Daerah",
              sourceUrl: "https://hariandaerah.com/csr-pt-kristalin-ekalestari-506-paket-sembako-untuk-janda-lansia-dan-tempat-ibadah-di-nabire/",
              image: "/agus8.jpg",
              content: `
                                <div class="space-y-8">
                                    <!-- Opening Story -->
        ...
        newsItems: [
          ...
          },
          {
            ...
            fullContent: {
              ...
              sourceUrl: "https://www.poskota.co.id/2025/08/30/merger-strategis-pt-torindo-jaya-persada-fokus-ekspansi-alat-berat-di-sektor-pertambangan",
              image: "/sept3.webp",
              content: `
        ...
        newsItems: [
          {
            ...
            fullContent: {
              ...
              image: "/pt-abadi-bersama-sentosa-meresmikan-penggilingan-padi-di-boy-4ubf.jpg",
              content: ""
              // Will use translation content from NewsDetail.tsx
            }
          },
          {
            id: "dec-2",
...
const KristalinNewsPage = () => {
  var _a, _b, _c, _d;
  const { t } = useTranslation();
  const getTranslatedArticle = (articleId) => {
  ...
  const [selectedCategory, setSelectedCategory] = useState(t("pages.news.categories.all"));
  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative flex min-h-screen flex-col overflow-x-hidden bg-white", children: [
    /* @__PURE__ */ jsxs(Head, { title: "News & Press Releases | PT Kristalin Ekalestari", children: [
      /* @__PURE__ */ jsx("meta", { name: "description", content: "Berita resmi, siaran pers, dan liputan kegiatan operasional serta CSR PT Kristalin Ekalestari: Penyerahan kendaraan operasional Dewan Adat Meyah, program Kisara Gold, bantuan sosial masyarakat Papua." }),
      /* @__PURE__ */ jsx("meta", { property: "og:title", content: "News & Press Releases - PT Kristalin Ekalestari" }),
      /* @__PURE__ */ jsx("meta", { property: "og:description", content: "Berita resmi, siaran pers, dan dokumentasi program berkelanjutan PT Kristalin Ekalestari." })
    ] }),
    ...
    /* @__PURE__ */ jsxs("section", { className: "relative flex min-h-screen flex-col items-center justify-center overflow-hidden", children: [
      /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsx("img", { src: imageUrl("news.jpg"), alt: "Mining operations and news background", className: "h-full w-full object-cover" }),
              ...
              children: [
                    ...
                    children: [
                      /* @__PURE__ */ jsx(
                        motion.span,
                        {
                          ...
                          children: t("pages.news.hero.title_line1")
                        }
                      ),
                      /* @__PURE__ */ jsx("br", {}),
                      /* @__PURE__ */ jsx(
                        motion.span,
                        {
                          ...
                          children: t("pages.news.hero.title_line2")
                        }
                      )
                    ]
                  }
                ...
                /* @__PURE__ */ jsx(
                  motion.p,
                  {
                    ...
                    children: t("pages.news.hero.description")
                  }
                ),
                /* @__PURE__ */ jsx(
                  motion.div,
                  {
                    ...
                    children: /* @__PURE__ */ jsxs(
                      "form",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsx("div", { className: "absolute inset-0 rounded-2xl bg-gradient-to-r from-amber-400 to-yellow-400 opacity-20 blur-sm transition-opacity duration-300 group-hover:opacity-30" }),
                          /* @__PURE__ */ jsxs("div", { className: "relative flex w-full items-center gap-2 rounded-2xl border-2 border-amber-400/30 bg-black/30 px-3 py-2 shadow-lg backdrop-blur-md transition-all duration-300 focus-within:ring-2 focus-within:ring-amber-400 sm:gap-3 sm:px-6 sm:py-4", children: [
                            /* @__PURE__ */ jsx(
                              Search,
                              {
                                className: `h-5 w-5 transition-all duration-300 sm:h-6 sm:w-6 ${isSearching ? "animate-spin text-amber-500" : "text-amber-400"}`
                              }
                            ),
                            /* @__PURE__ */ jsx(
                              "input",
                            ...
                            /* @__PURE__ */ jsxs(
                              "button",
                              {
                                ...
                                children: [
                                  ...
                                  /* @__PURE__ */ jsx(Search, { className: "inline h-4 w-4 sm:h-5 sm:w-5 lg:hidden" }),
                                  /* @__PURE__ */ jsx("span", { className: "relative hidden lg:inline", children: t("pages.news.hero.search_button") })
                                ]
                              }
                            )
                          ] })
                  ...
                  motion.div,
                  {
                    ...
                    children: categories.map((category, index) => /* @__PURE__ */ jsx(
                      motion.button,
                      {
                        ...
                        whileTap: { scale: 0.95 },
                        className: `rounded-full px-4 py-2 text-xs font-medium transition-all duration-300 sm:px-6 sm:py-3 sm:text-sm ${selectedCategory === category ? "bg-gradient-to-r from-amber-400 to-yellow-500 font-bold text-black shadow-lg" : "border border-white/20 bg-white/10 text-white backdrop-blur-sm hover:bg-white/20 hover:text-amber-400"}`,
                        children: category
                      },
                      category
                    ))
    ...
    /* @__PURE__ */ jsx("section", { className: "bg-gray-50 py-8 sm:py-12", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-6xl px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxs(
        motion.div,
        {
          initial: { opacity: 0, y: 30 },
          ...
          children: [
            /* @__PURE__ */ jsxs("h2", { className: "mb-3 text-xl font-bold text-gray-900 sm:mb-4 sm:text-2xl md:text-3xl", children: [
              t("pages.news.stats.title_line1"),
              " ",
              /* @__PURE__ */ jsx("span", { className: "text-amber-500", children: t("pages.news.stats.title_line2") })
            ] }),
            /* @__PURE__ */ jsx("p", { className: "mx-auto max-w-2xl px-4 text-sm text-gray-600 sm:text-base", children: t("pages.news.stats.description") })
          ]
        }
      ),
      /* @__PURE__ */ jsxs(
          ...
          children: [
            /* @__PURE__ */ jsxs(
              motion.div,
              {
                ...
                children: [
                  /* @__PURE__ */ jsx("div", { className: "mb-2 text-2xl font-bold text-amber-500 sm:mb-3 sm:text-3xl", children: /* @__PURE__ */ jsx(CounterAnimation, { end: totalArticles, delay: 200 }) }),
                  /* @__PURE__ */ jsx("h3", { className: "mb-1 text-sm font-semibold text-gray-900 sm:mb-2 sm:text-base", children: t("pages.news.stats.total_articles.label") }),
                  /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-600 sm:text-sm", children: t("pages.news.stats.total_articles.description") })
                ]
              }
            ),
            /* @__PURE__ */ jsxs(
              motion.div,
              {
                ...
                className: "rounded-lg bg-white p-4 text-center shadow-sm transition-shadow duration-300 hover:shadow-md sm:p-6",
                children: [
                  /* @__PURE__ */ jsx("div", { className: "mb-2 text-2xl font-bold text-amber-500 sm:mb-3 sm:text-3xl", children: /* @__PURE__ */ jsx(CounterAnimation, { end: totalCategories, delay: 400 }) }),
                  /* @__PURE__ */ jsx("h3", { className: "mb-1 text-sm font-semibold text-gray-900 sm:mb-2 sm:text-base", children: t("pages.news.stats.categories.label") }),
                  /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-600 sm:text-sm", children: t("pages.news.stats.categories.description") })
                ]
              }
            ),
            /* @__PURE__ */ jsxs(
              motion.div,
              {
                ...
                className: "rounded-lg bg-white p-4 text-center shadow-sm transition-shadow duration-300 hover:shadow-md sm:p-6",
                children: [
                  /* @__PURE__ */ jsx("div", { className: "mb-2 text-2xl font-bold text-amber-500 sm:mb-3 sm:text-3xl", children: /* @__PURE__ */ jsx(CounterAnimation, { end: totalMonths, delay: 600 }) }),
                  /* @__PURE__ */ jsx("h3", { className: "mb-1 text-sm font-semibold text-gray-900 sm:mb-2 sm:text-base", children: "Active Months" }),
                  /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-600 sm:text-sm", children: "Months with active news coverage" })
                ]
              }
            ),
            /* @__PURE__ */ jsxs(
              motion.div,
              {
                ...
                className: "rounded-lg bg-white p-4 text-center shadow-sm transition-shadow duration-300 hover:shadow-md sm:p-6",
                children: [
                  /* @__PURE__ */ jsx("div", { className: "mb-2 text-2xl font-bold text-amber-500 sm:mb-3 sm:text-3xl", children: /* @__PURE__ */ jsx(CounterAnimation, { end: 2025, delay: 800 }) }),
                  /* @__PURE__ */ jsx("h3", { className: "mb-1 text-sm font-semibold text-gray-900 sm:mb-2 sm:text-base", children: "Current Year" }),
                  /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-600 sm:text-sm", children: "2025 news and announcements" })
                ]
              }
            )
          ]
    ...
    /* @__PURE__ */ jsx("section", { className: "bg-gradient-to-br from-slate-50 via-white to-amber-50/30 py-8 sm:py-12 lg:py-16", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxs(
        motion.div,
        {
          initial: { opacity: 0, y: 30 },
          ...
          children: [
            /* @__PURE__ */ jsxs(
              motion.div,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxs("h2", { className: "mb-3 text-2xl font-bold tracking-tight text-slate-900 sm:mb-4 sm:text-3xl md:text-4xl lg:text-5xl", children: [
                    /* @__PURE__ */ jsx("span", { className: "bg-gradient-to-r from-amber-500 to-orange-500 bg-clip-text text-transparent", children: t("pages.news.highlights.title").split(" ")[0] }),
                    /* @__PURE__ */ jsxs("span", { className: "text-slate-900", children: [
                      " ",
                      t("pages.news.highlights.title").split(" ")[1]
                    ] })
                  ] }),
                  /* @__PURE__ */ jsx("div", { className: "mx-auto h-1 w-16 rounded-full bg-gradient-to-r from-amber-400 via-amber-500 to-orange-500 sm:w-20" })
                ]
              }
            ),
            /* @__PURE__ */ jsx(
              motion.p,
              {
                ...
                children: t("pages.news.highlights.subtitle")
              }
            )
          ]
        }
      ),
      /* @__PURE__ */ jsx("div", { className: "flex justify-center", children: /* @__PURE__ */ jsx("div", { className: "w-full max-w-2xl", children: /* @__PURE__ */ jsx(
        motion.div,
        {
          ...
          className: "group",
          children: /* @__PURE__ */ jsxs("div", { className: "relative h-[500px] overflow-hidden rounded-xl border border-amber-200/40 bg-gradient-to-br from-white via-amber-50/15 to-yellow-50/25 shadow-lg backdrop-blur-sm transition-all duration-500 hover:border-amber-300/60 hover:shadow-2xl sm:h-[550px] sm:rounded-2xl lg:h-[600px]", children: [
            /* @__PURE__ */ jsx("div", { className: "absolute top-0 left-0 h-2 w-full rounded-t-3xl bg-gradient-to-r from-amber-500 to-yellow-500" }),
            /* @__PURE__ */ jsx("div", { className: "absolute inset-0 opacity-5 transition-opacity duration-500 group-hover:opacity-10", children: /* @__PURE__ */ jsx(
              "img",
              {
            ...
            /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-br from-amber-500/10 via-transparent to-orange-100/15 opacity-0 transition-opacity duration-500 group-hover:opacity-100" }),
            /* @__PURE__ */ jsx("div", { className: "absolute top-0 right-0 h-24 w-24 rounded-bl-3xl bg-gradient-to-bl from-amber-100/25 to-transparent" }),
            /* @__PURE__ */ jsx("div", { className: "absolute bottom-0 left-0 h-20 w-20 rounded-tr-3xl bg-gradient-to-tr from-yellow-100/25 to-transparent" }),
            /* @__PURE__ */ jsx("div", { className: "absolute top-16 right-12 h-12 w-12 rounded-full bg-gradient-to-r from-amber-200/20 to-yellow-200/20" }),
            /* @__PURE__ */ jsx(
              motion.div,
              {
            ...
            /* @__PURE__ */ jsxs("div", { className: "relative flex h-full flex-col justify-between p-6 pt-8 sm:p-8 sm:pt-10", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx(motion.div, { className: "mb-4 sm:mb-5", whileHover: { scale: 1.05, y: -2 }, transition: { duration: 0.3 }, children: /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center rounded-full bg-gradient-to-r from-amber-500 via-yellow-500 to-amber-600 px-4 py-2 text-sm font-bold text-white shadow-lg ring-1 ring-white/20 backdrop-blur-sm sm:px-5 sm:py-2.5 sm:text-base", children: [
                  /* @__PURE__ */ jsx(
                    motion.span,
                    {
                  ...
                  ((_b = (_a = getTranslatedArticle("sept-3")) == null ? void 0 : _a.full_content) == null ? void 0 : _b.badge) || "STRATEGIC ACQUISITION"
                ] }) }),
                /* @__PURE__ */ jsx(
                  motion.h3,
                  {
                    ...
                    children: ((_c = getTranslatedArticle("sept-3")) == null ? void 0 : _c.title) || "Kristalin Ekalestari Group Mengakuisisi 51% Saham PT Torindo Jaya Persada untuk Ekspansi Industri Alat Berat"
                  }
                ),
                /* @__PURE__ */ jsx(
                  motion.p,
                  {
                    ...
                    whileHover: { x: 4 },
                    transition: { duration: 0.3 },
                    children: ((_d = getTranslatedArticle("sept-3")) == null ? void 0 : _d.excerpt) || "Konsolidasi strategis mayoritas 51% saham PT Torindo Jaya Persada melalui PT Armada Bumi Investama, memperkuat ekosistem bisnis alat berat pertambangan emas di kawasan Indonesia Timur dengan teknologi China modern dan jaringan distribusi terintegrasi."
                  }
                )
              ] }),
                  ...
                  motion.div,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                        /* @__PURE__ */ jsx(Calendar, { className: "h-5 w-5 text-amber-500 sm:h-6 sm:w-6" }),
                        /* @__PURE__ */ jsx("span", { className: "text-sm font-semibold text-gray-600 sm:text-base", children: "3 September 2025" })
                      ] }),
                      /* @__PURE__ */ jsx("span", { className: "inline-flex items-center rounded-full border border-amber-200 bg-amber-100 px-3 py-1.5 text-sm font-bold text-amber-800 sm:px-4 sm:py-2", children: "Strategic Acquisition" })
                    ]
                  }
                ),
                /* @__PURE__ */ jsx(Link, { href: "/news/sept-3", children: /* @__PURE__ */ jsxs(
                  motion.button,
                  {
    ...
    /* @__PURE__ */ jsx("section", { id: "news-archive", className: "scroll-mt-20 bg-white py-12 sm:py-16 lg:py-20", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxs(
        motion.div,
        {
          initial: { opacity: 0, y: 30 },
          ...
          children: [
            /* @__PURE__ */ jsxs(
              motion.div,
              {
                ...
                className: "inline-block",
                children: [
                  /* @__PURE__ */ jsx("h2", { className: "mb-4 text-3xl font-bold tracking-tight text-slate-900 sm:mb-6 sm:text-4xl md:text-5xl", children: t("pages.news.archive.title") }),
                  /* @__PURE__ */ jsx("div", { className: "mx-auto h-1 w-20 rounded-full bg-gradient-to-r from-amber-400 via-amber-500 to-orange-500 sm:w-24" })
                ]
              }
            ),
            /* @__PURE__ */ jsx(
              motion.p,
              {
                ...
                children: t("pages.news.archive.description")
              }
            )
          ]
        }
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative mx-auto max-w-5xl", children: [
        /* @__PURE__ */ jsx("div", { className: "absolute top-0 bottom-0 left-6 w-0.5 rounded-full bg-gradient-to-b from-amber-400 via-amber-500 to-transparent shadow-lg sm:left-12 sm:w-1" }),
        /* @__PURE__ */ jsx(
          motion.div,
          {
            ...
            children: newsDataByYear.map((yearGroup, yearIndex) => /* @__PURE__ */ jsxs(Fragment, { children: [
              /* @__PURE__ */ jsxs(
                motion.div,
                {
                  initial: { opacity: 0, y: 30 },
                  ...
                  className: "relative",
                  children: [
                    /* @__PURE__ */ jsx("div", { className: "absolute top-5 left-0 z-20 sm:top-6", children: /* @__PURE__ */ jsx("div", { className: "flex h-7 w-7 items-center justify-center rounded-full bg-gradient-to-r from-amber-500 to-amber-600 text-xs font-bold text-white shadow-lg ring-2 ring-white ring-offset-2 ring-offset-slate-50 sm:h-9 sm:w-9 sm:text-sm", children: yearGroup.year }) }),
                    /* @__PURE__ */ jsx("div", { className: "ml-16 sm:ml-24", children: /* @__PURE__ */ jsx("h3", { className: "text-lg font-bold tracking-tight text-slate-800 sm:text-xl", children: yearGroup.year }) })
                  ]
                }
              ),
              yearGroup.months.map(
                (monthData, monthIndex) => {
                  ...
                  const totalCategories2 = monthData.categories.length;
                  ...
                  return /* @__PURE__ */ jsxs(
                    motion.div,
                    {
                      ...
                      className: "relative",
                      children: [
                        /* @__PURE__ */ jsx("div", { className: "absolute top-6 left-0 z-20 sm:top-8", children: /* @__PURE__ */ jsx(
                          motion.div,
                          {
                            ...
                            children: /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                              /* @__PURE__ */ jsx("div", { className: "h-6 w-6 rounded-full bg-gradient-to-r from-amber-400 to-amber-600 shadow-lg ring-2 ring-white ring-offset-2 ring-offset-slate-50 transition-all duration-300 group-hover:shadow-xl group-hover:shadow-amber-200 sm:h-8 sm:w-8 sm:ring-4 sm:ring-offset-4" }),
                              /* @__PURE__ */ jsx(
                                motion.div,
                                {
                        ...
                        /* @__PURE__ */ jsxs("div", { className: "ml-16 sm:ml-24", children: [
                          /* @__PURE__ */ jsx(
                            motion.div,
                            {
                              ...
                              children: /* @__PURE__ */ jsx("div", { className: "rounded-xl border border-slate-200/50 bg-white/90 p-3 shadow-md backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg sm:p-4", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between", children: [
                                /* @__PURE__ */ jsxs("div", { className: "min-w-0 flex-1", children: [
                                  /* @__PURE__ */ jsx("h3", { className: "mb-2 text-xl font-bold tracking-tight text-slate-900 sm:text-2xl", children: getTranslatedMonth(monthData.monthId, t) }),
                                  /* @__PURE__ */ jsxs("p", { className: "text-sm font-medium text-slate-600 sm:text-base", children: [
                                    totalNews,
                                    " ",
                                    t("pages.news.archive.articles_count"),
                                    " ",
                                    totalCategories2,
                                    " ",
                                ...
                                /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-2 sm:gap-3", children: [
                                  /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center rounded-full bg-slate-100 px-3 py-1.5 text-xs font-semibold text-slate-700 shadow-sm sm:px-4 sm:py-2 sm:text-sm", children: [
                                    totalNews,
                                    " ",
                                    t("pages.news.stats.total_articles.label")
                                  ] }),
                                  /* @__PURE__ */ jsx("span", { className: "inline-flex items-center rounded-full bg-gradient-to-r from-amber-500 to-amber-600 px-3 py-1.5 text-xs font-semibold text-white shadow-md sm:px-4 sm:py-2 sm:text-sm", children: t("pages.news.archive.active_status") })
                                ] })
                              ] }) })
                            }
                          ),
                          /* @__PURE__ */ jsx(
                            "div",
                            {
                              className: `grid gap-4 sm:gap-6 ${monthData.categories.length === 1 ? "mx-auto max-w-3xl grid-cols-1" : "grid-cols-1 lg:grid-cols-2"}`,
                              children: monthData.categories.map((category, categoryIndex) => {
                                ...
                                return /* @__PURE__ */ jsx(
                                  motion.div,
                                  {
                                    ...
                                    children: /* @__PURE__ */ jsxs("div", { className: "overflow-hidden rounded-2xl border border-gray-200/60 bg-white/90 shadow-lg ring-1 ring-gray-200/30 backdrop-blur-sm transition-all duration-500 hover:-translate-y-2 hover:shadow-xl hover:shadow-amber-500/10", children: [
                                      /* @__PURE__ */ jsx(
                                        "button",
                                        {
                                          ...
                                          children: /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3 sm:gap-4", children: [
                                            /* @__PURE__ */ jsx("div", { className: "flex-shrink-0", children: /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                                              /* @__PURE__ */ jsx("div", { className: "flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-amber-500 to-yellow-500 shadow-md ring-1 ring-amber-100/50 sm:h-12 sm:w-12", children: /* @__PURE__ */ jsx("span", { className: "text-sm font-bold text-white sm:text-base", children: category.newsItems.length }) }),
                                              /* @__PURE__ */ jsx(
                                                motion.div,
                                                {
                                            ...
                                            /* @__PURE__ */ jsxs("div", { className: "min-w-0 flex-1", children: [
                                              /* @__PURE__ */ jsx("h4", { className: "mb-2 text-base leading-tight font-bold text-gray-900 transition-colors duration-300 group-hover:text-amber-700 sm:text-lg", children: getTranslatedCategoryTitle(category.id, t) }),
                                              /* @__PURE__ */ jsxs("p", { className: "mb-3 text-sm leading-relaxed font-medium text-gray-600 sm:text-base", children: [
                                                category.newsItems.length,
                                                " ",
                                                t("news_archive.ui_elements.articles_available")
                                              ] }),
                                              /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-2", children: [
                                                /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center rounded-full bg-gradient-to-r from-amber-50 to-yellow-50 px-3 py-1 text-xs font-semibold text-amber-700 shadow-sm ring-1 ring-amber-200/50 sm:text-sm", children: [
                                                  /* @__PURE__ */ jsx("div", { className: "mr-1.5 h-1.5 w-1.5 rounded-full bg-amber-500" }),
                                                  category.newsItems.length,
                                                  " ",
                                                  t("news_archive.ui_elements.articles")
                                                ] }),
                                                /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center rounded-full bg-gray-100 px-3 py-1 text-xs font-semibold text-gray-600 shadow-sm sm:text-sm", children: [
                                                  /* @__PURE__ */ jsx("div", { className: "mr-1.5 h-1.5 w-1.5 rounded-full bg-gray-400" }),
                                            ...
                                            /* @__PURE__ */ jsx(
                                              motion.div,
                                              {
                                                ...
                                                children: /* @__PURE__ */ jsx(ChevronDown, { className: "h-5 w-5 text-gray-600 transition-colors duration-300 group-hover:text-amber-600" })
                                              }
                                            )
                                          ] })
                                        }
                                      ...
                                      /* @__PURE__ */ jsx(
                                        motion.div,
                                        {
                                          ...
                                          children: /* @__PURE__ */ jsx("div", { className: "border-t border-gray-200/60 bg-gradient-to-br from-gray-50/80 to-amber-50/30 px-4 py-4 backdrop-blur-sm sm:px-5 sm:py-5", children: /* @__PURE__ */ jsx(
                                            "div",
                                            {
                                              className: `${category.newsItems.length > 3 ? "grid grid-cols-1 gap-3 sm:gap-4 md:grid-cols-2" : "space-y-3 sm:space-y-4"}`,
                                              children: category.newsItems.map((newsItem, newsIndex) => /* @__PURE__ */ jsx(
                                                motion.div,
                                                {
                                                  ...
                                                  children: /* @__PURE__ */ jsx(
                                                    Link,
                                                    {
                                                      ...
                                                      children: /* @__PURE__ */ jsxs("div", { className: "flex h-full flex-col space-y-3", children: [
                                                        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
                                                          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-sm text-gray-500", children: [
                                                            ...
                                                            /* @__PURE__ */ jsx("span", { className: "font-medium", children: newsItem.date })
                                                          ] }),
                                                          newsItem.fullContent && /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center rounded-full bg-green-100 px-2 py-1 text-xs font-semibold text-green-700", children: [
                                                            /* @__PURE__ */ jsx("div", { className: "mr-1 h-1.5 w-1.5 rounded-full bg-green-500" }),
                                                            t("news_archive.ui_elements.complete")
                                                          ] })
                                                        ] }),
                                                        /* @__PURE__ */ jsxs("div", { className: "flex flex-1 flex-col", children: [
                                                          /* @__PURE__ */ jsx("h5", { className: "mb-2 text-base leading-tight font-bold text-gray-900 transition-colors duration-300 group-hover/item:text-amber-700 sm:text-lg", children: getTranslatedArticleTitle(newsItem.id, t) || newsItem.title }),
                                                          /* @__PURE__ */ jsx("p", { className: "mb-3 flex-1 text-sm leading-relaxed text-gray-600", children: getTranslatedArticleExcerpt(newsItem.id, t) || newsItem.excerpt }),
                                                          /* @__PURE__ */ jsxs("div", { className: "mt-auto flex items-center justify-between", children: [
                                                            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-xs text-gray-400", children: [
                                                              ...
                                                              /* @__PURE__ */ jsx("span", { children: t("news_archive.ui_elements.read_more") })
                                                            ] }),
                                                            /* @__PURE__ */ jsx("div", { className: "flex h-8 w-8 items-center justify-center rounded-full bg-amber-100 transition-all duration-300 group-hover/item:scale-110 group-hover/item:bg-amber-200", children: /* @__PURE__ */ jsx(
                                                              "svg",
                                                              {
