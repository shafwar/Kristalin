    ...
    /* @__PURE__ */ jsxs("div", { className: "fixed bottom-0 left-0 right-0 z-50 flex items-center justify-between gap-3 border-t border-stone-200 bg-white/95 px-4 py-3 backdrop-blur-sm print:hidden md:bottom-auto md:left-auto md:right-8 md:top-8 md:border-0 md:bg-transparent md:backdrop-blur-none md:gap-4 md:justify-end md:px-0 md:py-0", children: [
      ...
      /* @__PURE__ */ jsxs(
        "button",
        {
          ...
          children: [
            isPrinting ? /* @__PURE__ */ jsx(Loader2, { className: "h-5 w-5 animate-spin" }) : /* @__PURE__ */ jsx(Printer, { className: "h-5 w-5" }),
            /* @__PURE__ */ jsx("span", { className: "text-sm md:text-base", children: isPrinting ? printLabel : t("pages.company_profile.print_btn") || "Print / Save as PDF" })
          ]
        }
      )
    ] }),
