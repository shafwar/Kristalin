...
import { Wheat, Home, GraduationCap, Trees, Sparkles, ShieldCheck } from "lucide-react";
import "react-dom";
function CsrSustainabilityPillars() {
  ...
  return /* @__PURE__ */ jsx("section", { className: "relative z-10 bg-gradient-to-b from-stone-50 via-white to-stone-50 py-16 sm:py-24 border-y border-stone-200/80", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: "inline-flex items-center gap-2 rounded-full border border-amber-300/80 bg-amber-50 px-4 py-1.5 shadow-xs", children: [
            /* @__PURE__ */ jsx(Sparkles, { className: "h-3.5 w-3.5 text-amber-700" }),
            /* @__PURE__ */ jsx("span", { className: "text-[11px] font-bold tracking-wider text-amber-900 uppercase", children: t("pages.csr.pillars.kicker") || "Framework Tanggung Jawab Sosial & Lingkungan (TJSL)" })
          ] }),
          /* @__PURE__ */ jsxs("h2", { className: "mt-4 text-3xl font-extrabold tracking-tight text-stone-900 sm:text-4xl lg:text-5xl", children: [
            /* @__PURE__ */ jsx("span", { className: "bg-gradient-to-r from-amber-600 via-yellow-600 to-amber-700 bg-clip-text text-transparent", children: t("pages.csr.pillars.title_line1") || "4 Pilar Keberlanjutan &" }),
            " ",
            /* @__PURE__ */ jsx("span", { className: "text-stone-900", children: t("pages.csr.pillars.title_line2") || "Pemberdayaan Masyarakat" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "mt-3 text-sm leading-relaxed text-stone-600 sm:text-base md:text-lg", children: t("pages.csr.pillars.description") || "Inisiatif keberlanjutan terstruktur PT Kristalin Ekalestari yang dirancang untuk mewujudkan kesejahteraan jangka panjang bagi masyarakat adat di lingkar tambang Nabire serta kelestarian alam Papua." })
        ]
      }
    ),
    /* @__PURE__ */ jsx("div", { className: "mt-12 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4 lg:gap-8", children: pillars.map((pillar, idx) => /* @__PURE__ */ jsxs(
      motion.div,
      {
        initial: { opacity: 0, y: 30 },
        whileInView: { opacity: 1, y: 0 },
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ jsx("span", { className: `inline-block rounded-full border px-3 py-0.5 text-[11px] font-bold tracking-wider uppercase shadow-xs ${pillar.badgeBg}`, children: pillar.pillarNo }),
              /* @__PURE__ */ jsx("div", { className: "flex h-11 w-11 items-center justify-center rounded-2xl bg-stone-50 border border-stone-200/80 shadow-xs transition-transform duration-300 group-hover:scale-110", children: pillar.icon })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "mt-5", children: [
              /* @__PURE__ */ jsx("span", { className: "text-[11px] font-bold text-amber-800 tracking-wider uppercase", children: pillar.tag }),
              /* @__PURE__ */ jsx("h3", { className: "mt-1 text-xl font-bold tracking-tight text-stone-900 sm:text-2xl", children: pillar.title })
            ] }),
            /* @__PURE__ */ jsx("p", { className: "mt-3 text-xs sm:text-sm leading-relaxed text-stone-600", children: pillar.description })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "mt-6 border-t border-stone-100 pt-4", children: /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-1.5", children: pillar.tags.map((tag, tagIdx) => /* @__PURE__ */ jsx(
            "span",
            {
