...
import { ChevronDown, ExternalLink, Calculator, RefreshCw, ShieldCheck, ChevronRight, X, CheckCircle2, Send, ArrowDownRight, Sparkles, Building2, FileText, Scale } from "lucide-react";
...
import { u as useKristalinTvGold, g as getBestSell1g, f as formatIdrAmount, a as useLcpSafeMicroMotion } from "./useKristalinTvGold-LFXoVBNd.js";
...
import { E as EsmdVerificationBadge } from "./EsmdVerificationModal-CbUZnxDf.js";
import "react-dom";
...
`
  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative mx-auto my-12 w-full max-w-4xl overflow-hidden rounded-3xl border border-amber-500/30 bg-gradient-to-b from-[#0c1626] via-[#091322] to-[#060c17] p-6 text-white shadow-2xl sm:p-10", children: [
    /* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute -left-20 -top-20 h-72 w-72 rounded-full bg-amber-500/15 blur-[90px]" }),
    /* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute -bottom-20 -right-20 h-72 w-72 rounded-full bg-yellow-500/10 blur-[90px]" }),
    /* @__PURE__ */ jsxs("div", { className: "relative z-10 flex flex-col items-start justify-between gap-4 border-b border-white/10 pb-6 md:flex-row md:items-center", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsx("span", { className: "flex h-6 w-6 items-center justify-center rounded-full bg-amber-500/20 text-amber-400", children: /* @__PURE__ */ jsx(Calculator, { className: "h-3.5 w-3.5" }) }),
          /* @__PURE__ */ jsx("span", { className: "text-xs font-bold tracking-[0.2em] text-amber-400 uppercase", children: t("pages.b2c.calculator.kicker") || "Simulasi & Kalkulator Emas" })
        ] }),
        /* @__PURE__ */ jsx("h3", { className: "mt-1 text-2xl font-bold text-white sm:text-3xl", children: t("pages.b2c.calculator.title") || "Kalkulator Investasi Logam Mulia" }),
        /* @__PURE__ */ jsx("p", { className: "mt-1 text-xs text-stone-300 sm:text-sm", children: t("pages.b2c.calculator.subtitle") || "Hitung estimasi nilai pembelian emas fisik Kisara Gold (99.99% 24K) secara instan." })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex shrink-0 items-center gap-3 rounded-2xl border border-white/10 bg-white/5 px-4 py-2.5 backdrop-blur-md", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5", children: [
            /* @__PURE__ */ jsx("span", { className: "h-2 w-2 animate-pulse rounded-full bg-emerald-400" }),
            /* @__PURE__ */ jsx("p", { className: "text-[10px] font-medium text-stone-400 uppercase", children: t("pages.b2c.calculator.live_price_per_gram") || "Harga Acuan per Gram:" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "font-mono text-sm font-bold text-amber-300 sm:text-base", children: formatIdrAmount(basePricePerGram) })
        ] }),
        /* @__PURE__ */ jsx(
          "button",
          {
            ...
            children: /* @__PURE__ */ jsx(RefreshCw, { className: `h-3.5 w-3.5 ${loading ? "animate-spin" : ""}` })
          }
        )
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "relative z-10 mt-8 grid grid-cols-1 gap-8 lg:grid-cols-12", children: [
      /* @__PURE__ */ jsxs("div", { className: "space-y-6 lg:col-span-7", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "mb-3 block text-xs font-semibold tracking-wider text-stone-300 uppercase", children: t("pages.b2c.calculator.select_weight") || "Pilih Gramatur Emas" }),
          /* @__PURE__ */ jsx("div", { className: "grid grid-cols-4 gap-2.5 sm:gap-3", children: GRAM_PRESETS.map((grams) => {
            ...
            return /* @__PURE__ */ jsxs(
              "button",
              {
                ...
                className: `group relative flex flex-col items-center justify-center rounded-xl border p-3 font-semibold transition-all duration-200 active:scale-95 ${active ? "border-amber-400 bg-gradient-to-b from-amber-500/25 to-yellow-500/10 text-white shadow-[0_0_15px_rgba(245,158,11,0.25)] ring-1 ring-amber-400" : "border-white/10 bg-white/5 text-stone-300 hover:border-white/20 hover:bg-white/10"}`,
                children: [
                  /* @__PURE__ */ jsx("span", { className: "text-base font-bold sm:text-lg", children: grams >= 1e3 ? `${grams / 1e3} kg` : `${grams}g` }),
                  /* @__PURE__ */ jsx("span", { className: `text-[10px] ${active ? "text-amber-300 font-medium" : "text-stone-400"}`, children: grams >= 1e3 ? "1.000 Gram" : `${grams} Gram` })
                ]
              },
              grams
            );
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "mb-2 block text-xs font-semibold tracking-wider text-stone-300 uppercase", children: t("pages.b2c.calculator.custom_weight") || "Atau Masukkan Gram Kustom:" }),
          /* @__PURE__ */ jsxs("div", { className: "relative", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute inset-y-0 right-4 flex items-center text-xs font-semibold text-amber-400 uppercase", children: t("pages.b2c.calculator.gram_unit") || "Gram" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 rounded-2xl border border-emerald-500/20 bg-emerald-950/30 p-3.5 text-xs text-emerald-300", children: [
          /* @__PURE__ */ jsx(ShieldCheck, { className: "h-5 w-5 shrink-0 text-emerald-400" }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("p", { className: "font-semibold text-emerald-200", children: t("pages.b2c.calculator.purity_label") || "Standar Kemurnian" }),
            /* @__PURE__ */ jsx("p", { className: "text-[11px] text-emerald-300/80", children: t("pages.b2c.calculator.purity_value") || "99.99% Emas Murni (24 Karat) Bersertifikat Resmi" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col justify-between rounded-2xl border border-white/15 bg-gradient-to-br from-white/10 via-white/5 to-transparent p-6 backdrop-blur-md lg:col-span-5", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsx("span", { className: "text-xs font-semibold tracking-wider text-stone-400 uppercase", children: t("pages.b2c.calculator.estimated_total") || "Estimasi Total Pembelian" }),
            /* @__PURE__ */ jsxs("span", { className: "rounded-full bg-amber-400/20 px-2 py-0.5 text-[10px] font-bold text-amber-300", children: [
              activeGrams,
              " Gram"
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "mt-3", children: [
            /* @__PURE__ */ jsx("p", { className: "font-mono text-3xl font-extrabold tracking-tight text-amber-300 sm:text-4xl", children: formatIdrAmount(estimatedTotal) }),
            /* @__PURE__ */ jsxs("p", { className: "mt-1 text-[11px] text-stone-400", children: [
              "≈ ",
              activeGrams,
              " g × ",
          ...
          /* @__PURE__ */ jsx("div", { className: "mt-6 border-t border-white/10 pt-4", children: /* @__PURE__ */ jsx("p", { className: "text-[10px] leading-relaxed text-stone-400", children: t("pages.b2c.calculator.pricing_note") || "* Harga bersifat indikatif mengikuti update pasar live. Kuotasi final dikunci saat verifikasi administrasi." }) })
        ] }),
    ...
    isRfqModalOpen && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-[9999] flex items-center justify-center bg-black/80 p-4 backdrop-blur-md", children: /* @__PURE__ */ jsxs("div", { className: "relative w-full max-w-lg overflow-hidden rounded-3xl border border-white/20 bg-stone-900 p-6 text-white shadow-2xl sm:p-8", children: [
      /* @__PURE__ */ jsx(
        "button",
        {
          type: "button",
      ...
      rfqStatus === "success" ? /* @__PURE__ */ jsxs("div", { className: "py-6 text-center", children: [
        /* @__PURE__ */ jsx("div", { className: "mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-emerald-500/20 text-emerald-400", children: /* @__PURE__ */ jsx(CheckCircle2, { className: "h-8 w-8" }) }),
        ...
        /* @__PURE__ */ jsx("p", { className: "mt-2 text-sm text-stone-300", children: t("pages.b2c.calculator.success_desc") || "Terima kasih. Tim penjualan Kristalin Ekalestari akan segera mengirimkan konfirmasi kuotasi resmi ke email Anda." }),
        /* @__PURE__ */ jsx(
          "button",
          {
            type: "button",
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h4", { className: "text-xl font-bold text-white", children: t("pages.b2c.calculator.rfq_modal_title") || "Permintaan Kuotasi Emas Resmi" }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-amber-500/30 bg-amber-500/10 p-3 text-xs text-amber-200", children: [
          /* @__PURE__ */ jsx("span", { className: "font-bold", children: t("pages.b2c.calculator.selected_summary") || "Ringkasan Pilihan:" }),
          " ",
          activeGrams,
          " Gram Emas 24K (Estimasi: ",
...
function B2cPage() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative flex min-h-screen flex-col overflow-x-hidden bg-stone-50 text-stone-900", children: [
    ...
    /* @__PURE__ */ jsxs("div", { ref: scrollAnimScopeRef, children: [
      ...
      /* @__PURE__ */ jsx("section", { className: "relative z-10 bg-stone-900 px-4 py-12 md:py-16", children: /* @__PURE__ */ jsx("div", { "data-b2c-reveal": true, className: "mx-auto max-w-5xl", children: /* @__PURE__ */ jsx(GoldBullionCalculator, {}) }) }),
