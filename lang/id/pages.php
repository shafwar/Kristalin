...
Melalui program Corporate Social Responsibility (CSR) membantu warga yang belum punya rumah dan renovasi total rumah tidak layak. PT Kristalin Ekalestari selain membangun rumah untuk warga yang belum memiliki rumah dan bedah rumah, membangun Pembangunan gereja, pendidikan, bantuan sembako, kendaraan operasional masyarakat dan gereja.',
    ...
    'b2c' => [
        ...
        'calculator' => [
            'kicker' => 'Simulasi & Estimasi Logam Mulia',
            'title' => 'Kalkulator Investasi Emas Batangan 24K',
            'subtitle' => 'Hitung estimasi nilai pembelian emas fisik bersertifikat murni 99.99% (Kisara Gold) secara instan dan transparan berdasarkan harga pasar acuan hari ini.',
            'select_weight' => 'Pilih Gramatur Emas Batangan (Minted Bars)',
            'custom_weight' => 'Atau Masukkan Berat Kustom (Gram)',
            'gram_unit' => 'Gram',
            'purity_label' => 'Jaminan Kemurnian 99.99% (24 Karat)',
            'purity_value' => 'Emas murni bersertifikat resmi dengan kemasan segel keamanan tinggi (Assay Stamp).',
            'live_price_per_gram' => 'Harga Acuan Pasar Hari Ini',
            'estimated_total' => 'Estimasi Total Pembelian',
            'breakdown_rate' => 'Harga Acuan Hari Ini',
            'breakdown_purity' => 'Standar Kemurnian',
            'breakdown_cert' => 'Sertifikasi & Segel Keamanan',
            'breakdown_cert_val' => 'Termasuk (Official Assay)',
            'pricing_note' => '* Estimasi nilai dihitung secara indikatif mengikuti harga acuan pasar terkini. Kuotasi final dikunci saat konfirmasi transaksi.',
            'cta_rfq' => 'Minta Penawaran Resmi (RFQ)',
            'rfq_modal_title' => 'Permintaan Kuotasi Emas Resmi',
            'rfq_modal_desc' => 'Kirim detail estimasi pembelian Anda langsung ke tim penjualan PT Kristalin Ekalestari.',
            'selected_summary' => 'Ringkasan Pilihan:',
            'field_name' => 'Nama Lengkap',
            'field_email' => 'Alamat Email',
            'field_phone' => 'Nomor WhatsApp / Telepon (Opsional)',
            'field_notes' => 'Catatan Tambahan (Opsional)',
            'send_btn' => 'Kirim Permintaan Kuotasi',
            'sending_btn' => 'Mengirim Kuotasi...',
            'success_title' => 'Permintaan Kuotasi Terkirim!',
            'success_desc' => 'Terima kasih. Tim penjualan Kristalin Ekalestari akan segera mengirimkan konfirmasi kuotasi resmi ke email Anda.',
        ],
    ],
