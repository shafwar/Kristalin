...
return [
    ...
    'csr' => [
        ...
        'pillars' => [
            'kicker' => 'Framework Tanggung Jawab Sosial & Lingkungan (TJSL)',
            'title_line1' => '4 Pilar Keberlanjutan &',
            'title_line2' => 'Pemberdayaan Masyarakat',
            'description' => 'Inisiatif keberlanjutan terstruktur PT Kristalin Ekalestari yang dirancang untuk mewujudkan kesejahteraan jangka panjang bagi masyarakat adat di lingkar tambang Nabire serta kelestarian alam Papua.',
            'items' => [
                'food_security' => [
                    'pillar_no' => 'Pilar 01',
                    'title' => 'Pilar Ketahanan Pangan',
                    'tag' => 'Distribusi Sembako Berkala',
                    'description' => 'Program penyaluran paket sembako bergizi secara rutin kepada keluarga masyarakat adat, janda lansia, dan pemuka adat di sekitar area operasional pertambangan untuk memastikan kecukupan gizi harian.',
                    'tags' => ['Penyaluran Sembako Rutin', 'Masyarakat Adat Nabire', 'Jaring Pengaman Sosial'],
                ],
                'infrastructure' => [
                    'pillar_no' => 'Pilar 02',
                    'title' => 'Pilar Infrastruktur & Hunian',
                    'tag' => 'Pemukiman & Fasilitas Air Bersih',
                    'description' => 'Bantuan pembangunan unit rumah layak huni bagi warga adat Kampung Nifasi, pembangunan jaringan perpipaan air bersih pedesaan, serta pemeliharaan sarana jalan pemukiman.',
                    'tags' => ['Rumah Layak Huni', 'Akses Air Bersih', 'Fasilitas Desa Nifasi'],
                ],
                'education_health' => [
                    'pillar_no' => 'Pilar 03',
                    'title' => 'Pilar Pendidikan & Kesehatan',
                    'tag' => 'Dukungan Belajar & Sarana Medis',
                    'description' => 'Penyediaan perlengkapan sekolah, beasiswa pendidikan bagi putra-putri berprestasi Nabire hingga jenjang lanjutan, dan dukungan fasilitas operasional pos pelayanan kesehatan masyarakat.',
                    'tags' => ['Beasiswa Siswa Berprestasi', 'Perlengkapan Belajar', 'Pos Pelayanan Medis'],
                ],
                'reclamation' => [
                    'pillar_no' => 'Pilar 04',
                    'title' => 'Pilar Reklamasi Progresif',
                    'tag' => 'Konservasi & Revegetasi Lahan',
                    'description' => 'Komitmen penataan kembali kontur tanah pasca-tambang, pengelolaan sedimen dan kualitas air, serta penanaman vegetasi endemik untuk memulihkan keanekaragaman hayati ekosistem Papua.',
                    'tags' => ['Revegetasi Bertahap', 'Penataan Tanah Pucuk', 'Pemulihan Keanekaragaman Hayati'],
                ],
            ],
            'assurance_title' => 'Harmonisasi Berkelanjutan dengan Masyarakat Adat Papua',
            'assurance_desc' => 'Seluruh program TJSL dan operasional tambang PT Kristalin Ekalestari berlandaskan pada persetujuan musyawarah adat, kepatuhan AMDAL lingkungan hidup, serta komitmen kemitraan berkesinambungan.',
        ],
        'programs' => [
...
Melalui program Corporate Social Responsibility (CSR) membantu warga yang belum punya rumah dan renovasi total rumah tidak layak. PT Kristalin Ekalestari selain membangun rumah untuk warga yang belum memiliki rumah dan bedah rumah, membangun Pembangunan gereja, pendidikan, bantuan sembako, kendaraan operasional masyarakat dan gereja.',
    ...
    'b2c' => [
        ...
        'calculator' => [
            ...
            'title' => 'Simulasi Pemesanan Emas Batangan 24K',
            'subtitle' => 'Akses langsung likuiditas emas murni 99.99% standar bersertifikat resmi dari ekosistem pemurnian PT Kristalin Ekalestari.',
            'select_weight' => 'Pilih Gramatur Emas Batangan (Minted Bars)',
            'selected_label' => 'Terpilih',
            'gram_unit' => 'Gram',
            'custom_weight' => 'Berat Kustom (Custom Grams)',
            ...
            'breakdown_cert_val' => 'Termasuk (Official Assay)',
            'breakdown_shipping' => 'Pengiriman Fisik',
            'breakdown_shipping_val' => 'Asuransi Penuh 100%',
            'pricing_note' => '* Nilai bersifat indikatif mengikuti harga acuan pasar spot harian. Kuotasi final dikunci saat pemesanan.',
            'cta_btn' => 'Minta Penawaran Resmi',
            'verified_note' => 'Kuotasi resmi diverifikasi PT Kristalin Ekalestari',
            'estimation_note_title' => 'Catatan Estimasi Sistem:',
            'estimation_note' => 'Dihitung berdasarkan harga acuan pasar spot live. Harga final dan nomor seri segel dikonfirmasi saat penerbitan invoice resmi.',
            'trust_purity_title' => 'Kemurnian 99.99%',
            'trust_purity_desc' => 'Fine Gold 24K standar SNI & LBMA.',
        ...
        'calculator' => [
            'refinery_badge' => 'Pasokan Langsung Pemurnian · Kisara Gold 24K',
            'title' => 'Simulasi Pemesanan Emas Batangan 24K',
            'subtitle' => 'Estimasi real-time emas murni 99.99% langsung dari ekosistem produksi PT Kristalin Ekalestari.',
            ...
            'quick_add' => 'Tambah Cepat:',
            'estimation_note_title' => 'Catatan Estimasi Sistem:',
            'estimation_note' => 'Dihitung berdasarkan harga acuan pasar spot terkini. Harga final dan nomor seri segel dikonfirmasi saat penerbitan invoice resmi.',
            'live_price_per_gram' => 'Harga Acuan Pasar Hari Ini',
            'per_gram' => 'gram',
            'estimated_total' => 'Estimasi Total Pembelian',
            'breakdown_rate' => 'Harga Acuan',
            ...
            'breakdown_shipping' => 'Pengiriman Fisik',
            'breakdown_shipping_val' => 'Asuransi Penuh 100%',
            'pricing_note' => '* Nilai bersifat indikatif mengikuti harga acuan pasar harian. Kuotasi final dikunci saat transaksi.',
            'cta_btn' => 'Minta Penawaran Resmi',
            'verified_note' => 'Kuotasi resmi diverifikasi PT Kristalin Ekalestari',
            'trust_purity_title' => 'Kemurnian 99.99%',
            'trust_purity_desc' => 'Fine Gold 24K standar SNI & LBMA.',
