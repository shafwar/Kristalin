...
export function EsmdVerificationModal({ isOpen, onClose }: EsmdVerificationModalProps) {
    ...
    const modalContent = (
        <div 
            ...
            aria-modal="true"
        >
            <div className="relative my-auto w-full max-w-2xl overflow-hidden rounded-3xl border border-stone-200/90 bg-white p-6 sm:p-8 text-stone-900 shadow-2xl ring-1 ring-black/5">
                ...
                <div className="relative z-10 flex items-start gap-4 border-b border-stone-100 pb-5 pt-1">
                    <div className="flex h-12 w-12 sm:h-14 sm:w-14 shrink-0 items-center justify-center rounded-2xl border border-amber-200 bg-amber-50 text-amber-700 shadow-sm">
                        <Shield className="h-6 w-6 sm:h-7 sm:w-7" strokeWidth={2.2} />
                    </div>
                    <div className="pr-8">
                        <div className="flex flex-wrap items-center gap-2">
                            <span className="inline-flex items-center gap-1.5 rounded-full bg-emerald-50 border border-emerald-200/80 px-2.5 py-0.5 text-[11px] font-bold text-emerald-800 tracking-wide uppercase">
                        ...
                        <h3 className="mt-1.5 text-xl sm:text-2xl font-bold tracking-tight text-stone-900 leading-tight">
                ...
                <div className="relative z-10 mt-5 divide-y divide-stone-200/70 rounded-2xl border border-stone-200/80 bg-stone-50/70 overflow-hidden shadow-inner">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 divide-y sm:divide-y-0 sm:divide-x divide-stone-200/70">
                        <div className="p-4">
                            ...
                            <p className="mt-1 font-mono text-sm font-bold text-stone-900">
                                <span className="rounded-md border border-amber-300/80 bg-amber-100/70 px-2 py-0.5 text-amber-900">
                ...
                {/* Disclaimer Note */}
                <p className="relative z-10 mt-4 text-[11px] leading-relaxed text-stone-500">
                ...
                {/* Action Buttons */}
                <div className="relative z-10 mt-6 flex flex-col-reverse sm:flex-row items-stretch sm:items-center sm:justify-between gap-3 pt-2">
                    <button
                        type="button"
                        onClick={onClose}
        ...
        return (
            <>
                <button
                    ...
                    className={`group inline-flex items-center gap-2 rounded-full border px-3.5 py-1 text-xs font-semibold transition-all duration-200 active:scale-95 cursor-pointer ${
                        isDark
