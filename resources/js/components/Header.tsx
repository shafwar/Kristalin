            ...
            >
                ...
                <div className="flex items-center justify-center">
                    <a 
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex h-10 items-center justify-center px-2 py-1 text-white transition-all duration-300 ease-out hover:scale-105 hover:text-yellow-400 focus:outline-none"
