                ...
                <div className="block lg:hidden">
                    ...
                    <div className="relative h-[60vh] min-h-[400px] overflow-hidden bg-black">
                        ...
                        >
                            ...
                            <p className="mt-3 text-sm leading-relaxed text-white/80 sm:text-base">{t('pages.vision_mission.description')}</p>
                        </div>
                    </div>
                    ...
                    <div className="bg-white p-4 sm:p-6">
                        <div className="mx-auto max-w-2xl">
                                    ...
                                    <div className="flex items-start space-x-3 sm:space-x-4">
                                        ...
                                        <div className="flex-1 space-y-3">
                                            <div>
                                                ...
                                                <h3 className="text-lg leading-tight font-semibold text-yellow-800 sm:text-xl">
                                                    {t('pages.vision_mission.vision.title')}
                                                </h3>
                                            </div>
                                            <p className="text-sm leading-relaxed text-yellow-700 sm:text-base">
                            ...
                            {/* Mission Header */}
                            <div
                                className={`mb-6 transform transition-all delay-700 duration-1000 ${
                                    isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-6 opacity-0'
                                }`}
                            >
                                <div className="mb-3 flex items-center space-x-2">
                                ...
                                <h3 className="text-lg leading-relaxed font-light text-gray-900 sm:text-xl">
                                        ...
                                        <div className="flex items-start space-x-3">
                                            ...
                                            <div className="flex-1 space-y-2">
                                                <div>
                                                    ...
                                                    <h4
                                                        className={`text-sm leading-tight font-semibold transition-colors duration-300 sm:text-base ${
                                                ...
                                                <p
                                                    className={`leading-relaxed transition-all duration-500 ${
                                                        activeMission === index
                                                            ? 'text-xs text-gray-800 sm:text-sm'
                                                            : 'text-xs text-gray-600 group-hover:text-gray-800'
                                                    }`}
                                                >
                                                    {pillar.description}
                                                </p>
                                ...
                                <div className="space-y-4 text-center">
                                    <div className="space-y-2">
                                        <h4 className="text-base font-medium text-gray-900 sm:text-lg">
                                            {t('pages.vision_mission.cta.prosperity_title')}
                                        </h4>
                ...
                <div className="relative hidden w-full lg:flex" style={{ height: `calc(100vh - ${HEADER_HEIGHT + FOOTER_HEIGHT}px)` }}>
                    ...
                    <div className="relative h-full w-1/2 flex-shrink-0 overflow-hidden bg-black">
                        ...
                        >
                            ...
                            <p className="mt-4 max-w-md text-lg leading-relaxed text-white/80">{t('pages.vision_mission.description')}</p>
                        </div>
                    </div>
                        ...
                        <div ref={rightPanelRef} className="h-full overflow-y-auto" style={{ padding: '3rem 4rem' }}>
                            <div className="max-w-xl">
                                ...
                                >
                                    ...
                                    <h2 className="text-3xl leading-relaxed font-light text-gray-900">{t('pages.vision_mission.main_heading')}</h2>
                                </div>

                                {/* Vision Section */}
                                <div
                                    className={`mb-16 transform transition-all delay-500 duration-1000 ${
                                        isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-6 opacity-0'
                                    }`}
                                >
                                    <div className="rounded-2xl border border-yellow-200 bg-yellow-50 p-8">
                                        <div className="flex items-start space-x-6">
                                            ...
                                            <div className="flex-1 space-y-4">
                                                <div>
                                                    <div className="mb-2 text-xs font-semibold tracking-wider text-yellow-600 uppercase">
                                                        {t('pages.vision_mission.vision.label')}
                                                    </div>
                                                    <h3 className="text-2xl leading-tight font-semibold text-yellow-800">
                                                        {t('pages.vision_mission.vision.title')}
                                                    </h3>
                                                </div>
                                                <p className="leading-relaxed text-yellow-700">{t('pages.vision_mission.vision.content')}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                >
                                    ...
                                    <h3 className="text-2xl leading-relaxed font-light text-gray-900">{t('pages.vision_mission.mission.title')}</h3>
                                </div>
                                            ...
                                            <div className="flex items-start space-x-4">
                                                ...
                                                <div className="flex-1 space-y-3">
                                                    <div>
                                                        ...
                                                        <h4
                                                            className={`text-lg leading-tight font-semibold transition-colors duration-300 ${
                                                                activeMission === index
                                                                    ? 'text-yellow-700'
                                ...
                                >
                                    <div className="space-y-6 text-center">
                                        <div className="space-y-2">
                                            ...
                                            <p className="text-sm leading-relaxed text-gray-600">{t('pages.vision_mission.cta.prosperity_desc')}</p>
                                        </div>
