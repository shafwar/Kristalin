    ...
    return (
        <>
            ...
            <div className="welcome-page relative flex min-h-screen flex-col overflow-x-hidden bg-white">
                ...
                {!showLoadingScreen && (
                    <div className="w-full border-t border-amber-200/50 bg-amber-50/90 py-3 text-center">
                        <Link
                            href="/internal-feedback"
                            className="inline-flex items-center gap-2 rounded-full px-4 py-2 text-sm font-medium text-amber-800 transition-all hover:bg-amber-100 hover:text-amber-900"
                        >
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="shrink-0">
                                <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />
                            </svg>
                            <span>{t('pages.internal_feedback.page_title')}</span>
