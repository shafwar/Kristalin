        ...
        <div className="relative flex min-h-screen flex-col overflow-x-hidden bg-white">
                            ...
                            >
                                <div className="flex items-start gap-3 sm:gap-4">
                                    ...
                                    <div className="min-w-0 flex-1">
                                        <h3 className="mb-2 text-lg font-bold text-white sm:mb-3 sm:text-xl lg:text-2xl">
                                            {t('pages.line_of_business.values.integrity.title')}
                                        </h3>
                                        <p className="text-xs leading-relaxed font-light text-white/85 sm:text-sm lg:text-base">
            ...
            >
                ...
                <div className="grid grid-cols-1 items-center gap-16 lg:grid-cols-2">
                    ...
                    <motion.div variants={slideInLeft} transition={{ delay: 0.3, duration: 0.4, ease: 'easeInOut' }} className="space-y-6">
                        <div className="grid grid-cols-1 gap-4">
                            ...
                            >
                                <div className="mt-2 h-2 w-2 flex-shrink-0 rounded-full bg-yellow-600"></div>
                                <div>
            ...
            <motion.section initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} className="bg-gray-50 py-20">
                <div className="mx-auto max-w-6xl px-4">
                    <motion.div variants={fadeInUp} transition={{ duration: 0.4, ease: 'easeInOut' }} className="mb-16 text-center">
                        <h2 className="mb-4 text-sm font-semibold tracking-[0.25em] text-gray-700">{t('pages.line_of_business.services.header')}</h2>
                        <div className="mx-auto mb-12 h-0.5 w-20 bg-yellow-600"></div>
                        <h3 className="text-4xl font-normal text-gray-800 md:text-5xl lg:text-6xl">{t('pages.line_of_business.services.title')}</h3>
                    </motion.div>

                    <div className="mt-20 grid grid-cols-1 gap-16 lg:grid-cols-2 lg:gap-20">
                        {/* Gold Mining & Processing */}
                        <motion.div variants={slideInLeft} transition={{ delay: 0.3, duration: 0.4, ease: 'easeInOut' }} className="text-center">
                            <motion.div whileHover={{ scale: 1.1, rotate: 5 }} transition={{ duration: 0.4 }} className="mb-8 flex justify-center">
                                <div className="flex h-20 w-20 items-center justify-center rounded-full bg-yellow-600 shadow-lg">
                            ...
                            <h4 className="mb-6 text-xl font-semibold tracking-wide text-gray-800">
                        ...
                        <motion.div variants={slideInRight} transition={{ delay: 0.5, duration: 0.4, ease: 'easeInOut' }} className="text-center">
                            <motion.div whileHover={{ scale: 1.1, rotate: -5 }} transition={{ duration: 0.4 }} className="mb-8 flex justify-center">
                                <div className="flex h-20 w-20 items-center justify-center rounded-full bg-yellow-600 shadow-lg">
                                    <svg className="h-10 w-10 text-white" fill="currentColor" viewBox="0 0 24 24">
            ...
            <motion.section initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} className="bg-black py-20">
                <div className="mx-auto max-w-4xl px-4 text-center">
                    <motion.div variants={fadeInUp} transition={{ duration: 0.4, ease: 'easeInOut' }}>
                        <motion.div
            ...
            {/* How We Work Section */}
            <motion.section initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} className="bg-white py-20">
                <div className="mx-auto max-w-6xl px-4">
                    <motion.div variants={fadeInUp} transition={{ duration: 0.4, ease: 'easeInOut' }} className="mb-16 text-center">
                        <h2 className="mb-4 text-sm font-semibold tracking-[0.25em] text-gray-700">
                    ...
                    <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:gap-16">
                        ...
                        >
                            <motion.div whileHover={{ scale: 1.1, rotateY: 180 }} transition={{ duration: 0.4 }} className="mb-6 flex justify-center">
                                <div className="flex h-20 w-20 items-center justify-center rounded-2xl bg-gray-800 transition-all duration-300 group-hover:bg-yellow-600">
                                    <svg className="h-10 w-10 text-white" fill="currentColor" viewBox="0 0 24 24">
                                        <path d="M19 3H5C3.9 3 3 3.9 3 5V19C3 20.1 3.9 21 5 21H19C20.1 21 21 20.1 21 19V5C21 3.9 20.1 3 19 3ZM9 17H7V10H9V17ZM13 17H11V7H13V17ZM17 17H15V13H17V17Z" />
                                    </svg>
                                </div>
                            </motion.div>
                            <h4 className="mb-4 text-xl font-semibold text-gray-800">{t('pages.line_of_business.how_we_work.steps.step1.title')}</h4>
                            <p className="leading-relaxed text-gray-600">{t('pages.line_of_business.how_we_work.steps.step1.description')}</p>
                        </motion.div>
                        ...
                        >
                            ...
                            <h4 className="mb-4 text-xl font-semibold text-gray-800">{t('pages.line_of_business.how_we_work.steps.step2.title')}</h4>
                            <p className="leading-relaxed text-gray-600">{t('pages.line_of_business.how_we_work.steps.step2.description')}</p>
                        </motion.div>
                        ...
                        >
                            ...
                            <h4 className="mb-4 text-xl font-semibold text-gray-800">{t('pages.line_of_business.how_we_work.steps.step3.title')}</h4>
                            <p className="leading-relaxed text-gray-600">{t('pages.line_of_business.how_we_work.steps.step3.description')}</p>
                        </motion.div>
            ...
            <motion.section initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} className="bg-white py-20">
                <div className="mx-auto max-w-6xl px-4">
                    ...
                    <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
                        ...
                        >
                            <p className="mb-8 max-w-lg text-lg font-light text-gray-700 md:text-xl">
                ...
                <div className="mx-auto max-w-6xl px-4">
                    <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
                        ...
                        <motion.div variants={slideInLeft} transition={{ duration: 0.4, ease: 'easeInOut' }}>
                            ...
                            <p className="mb-8 text-xl text-white/90">{t('pages.line_of_business.why_choose_us.subtitle')}</p>
                            ...
                            >
                                <a href="/contact">{t('pages.line_of_business.why_choose_us.contact_button')}</a>
                            </motion.button>
                        </motion.div>
