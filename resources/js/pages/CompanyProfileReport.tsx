...
export default function CompanyProfileReport() {
    ...
    return (
        <div className="min-h-screen bg-stone-100 py-8 print:bg-white print:py-0">
            ...
            <div className="mx-auto w-[210mm] bg-white shadow-2xl print:shadow-none text-stone-800 [zoom:40%] md:[zoom:50%] lg:[zoom:65%] xl:[zoom:75%] 2xl:[zoom:85%] print:![zoom:100%]">
                
                {/* ----------------- PAGE 1: COVER ----------------- */}
                <div className="relative flex h-[297mm] flex-col overflow-hidden bg-stone-950 text-white print:h-[297mm]">
                    ...
                    <div className="relative z-10 p-16 flex h-full flex-col justify-between">
                ...
                <div className="flex flex-col p-16 min-h-[297mm] print:h-[297mm] print:break-before-page">
                    
                    {/* Executive Summary */}
                    <div className="mb-12">
                        <div className="inline-block mb-6">
                            <h2 className="text-4xl font-bold text-stone-900 border-b-4 border-amber-500 pb-3">
                ...
                <div className="flex flex-col p-16 min-h-[297mm] print:h-[297mm] print:break-before-page relative overflow-hidden bg-white">
                    ...
                    <div className="flex-grow flex flex-col justify-center max-w-4xl mx-auto">
                        <div className="relative bg-stone-50 p-12 rounded-3xl border border-stone-200 shadow-sm">
                            ...
                            <p className="text-xl leading-loose text-stone-700 italic relative z-10 font-medium">
                ...
                <div className="flex flex-col p-16 min-h-[297mm] print:h-[297mm] print:break-before-page">
                    ...
                    <div className="mb-12 flex gap-8">
                        <div className="w-1/2 bg-stone-900 rounded-3xl p-8 text-white shadow-xl relative overflow-hidden">
                            <div className="absolute -right-4 -top-4 opacity-10">
                                <Eye className="h-32 w-32" />
                            </div>
                            <Eye className="h-10 w-10 text-amber-500 mb-6" />
                            <h2 className="text-3xl font-bold mb-4">{t('pages.company_profile.vision_title') || 'Our Vision'}</h2>
                        ...
                        <div className="w-1/2 bg-amber-500 rounded-3xl p-8 text-white shadow-xl relative overflow-hidden">
                            <div className="absolute -right-4 -top-4 opacity-10 text-black">
                                <Target className="h-32 w-32" />
                            </div>
                            <Target className="h-10 w-10 text-stone-900 mb-6" />
                            <h2 className="text-3xl font-bold text-stone-900 mb-4">{t('pages.company_profile.mission_title') || 'Our Mission'}</h2>
                        ...
                        <div className="flex-grow flex flex-col justify-center">
                            <div className="relative border-l-2 border-stone-200 ml-8 space-y-16 pb-8">
                                <div className="relative pl-14">
                                    <div className="absolute -left-[33px] top-1 h-16 w-16 rounded-full bg-amber-50 border-4 border-white shadow-sm flex items-center justify-center">
                                        <History className="h-7 w-7 text-amber-500" />
                                    </div>
                                    <h3 className="text-4xl font-bold text-amber-500 mb-3">{t('pages.company_profile.ms_1989') || '1989'}</h3>
                                    <h4 className="text-2xl font-bold text-stone-900 mb-3">{t('pages.company_profile.ms_1989_title') || 'Foundation'}</h4>
                                    <p className="text-stone-600 text-lg leading-relaxed">{t('pages.company_profile.ms_1989_text') || 'Established in Papua with a focus on sustainable gold exploration and community engagement.'}</p>
                                </div>
                                ...
                                <div className="relative pl-14">
                                    ...
                                    <h3 className="text-4xl font-bold text-amber-500 mb-3">{t('pages.company_profile.ms_2005') || '2005'}</h3>
                                    <h4 className="text-2xl font-bold text-stone-900 mb-3">{t('pages.company_profile.ms_2005_title') || 'First Refinery'}</h4>
                                    <p className="text-stone-600 text-lg leading-relaxed">{t('pages.company_profile.ms_2005_text') || 'Opened our first state-of-the-art refining facility in Jakarta, enabling end-to-end processing.'}</p>
                                </div>
                                ...
                                <div className="relative pl-14">
                                    ...
                                    <h3 className="text-4xl font-bold text-amber-500 mb-3">{t('pages.company_profile.ms_2015') || '2015'}</h3>
                                    <h4 className="text-2xl font-bold text-stone-900 mb-3">{t('pages.company_profile.ms_2015_title') || 'LBMA Certification'}</h4>
                                    <p className="text-stone-600 text-lg leading-relaxed">{t('pages.company_profile.ms_2015_text') || 'Achieved international LBMA standard for our 99.99% gold bars, recognizing our world-class quality.'}</p>
                                </div>
                                ...
                                <div className="relative pl-14">
                                    ...
                                    <h3 className="text-4xl font-bold text-amber-500 mb-3">{t('pages.company_profile.ms_2026') || '2026'}</h3>
                                    <h4 className="text-2xl font-bold text-stone-900 mb-3">{t('pages.company_profile.ms_2026_title') || 'Digital Transformation'}</h4>
                                    <p className="text-stone-600 text-lg leading-relaxed">{t('pages.company_profile.ms_2026_text') || 'Launched B2C digital platform connecting physical gold directly to investors.'}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="flex flex-col p-16 min-h-[297mm] print:h-[297mm] print:break-before-page">
                    <div className="flex-grow flex flex-col">
                        ...
                        <div className="flex-grow flex flex-col justify-between gap-6">
                            ...
                            <div className="rounded-3xl bg-white p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-stone-100 border-l-4 border-l-amber-500 flex gap-8 items-center flex-grow">
                                <div className="flex-shrink-0 h-20 w-20 rounded-full bg-amber-50 flex items-center justify-center border border-amber-100">
                            ...
                            <div className="rounded-3xl bg-white p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-stone-100 border-l-4 border-l-amber-500 flex gap-8 items-center flex-grow">
                                ...
                                <div className="flex-grow">
                                    ...
                                    <p className="text-stone-600 text-lg leading-relaxed mb-4">{t('pages.company_profile.lob_midstream_text') || 'Our advanced Smelter & Refinery infrastructure processes gold ore into certified precious metal bars, achieving 99.99% purity. We adhere strictly to international LBMA standards.'}</p>
                            ...
                            <div className="rounded-3xl bg-white p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-stone-100 border-l-4 border-l-amber-500 flex gap-8 items-center flex-grow">
                                ...
                                <div className="flex-grow">
                                    ...
                                    <p className="text-stone-600 text-lg leading-relaxed mb-4">{t('pages.company_profile.lob_downstream_text') || 'Connecting physical gold directly to the consumer market (B2C) through our digital platforms and strategic partnerships, offering investment-grade gold directly to the public.'}</p>
                ...
                <div className="flex flex-col p-16 min-h-[297mm] print:h-[297mm] print:break-before-page">
                    <div className="flex-grow flex flex-col">
                        ...
                        <p className="text-xl leading-relaxed text-stone-700 mb-10">
                        ...
                        <div className="flex-grow flex flex-col justify-between gap-6">
                            <div className="rounded-3xl bg-white p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-stone-100 border-l-4 border-l-emerald-500 flex gap-8 items-center flex-grow">
                                <div className="flex-shrink-0 h-20 w-20 rounded-full bg-emerald-50 flex items-center justify-center border border-emerald-100">
                                ...
                                <div className="flex-grow">
                                    ...
                                    <p className="text-stone-600 text-lg leading-relaxed mb-4">{t('pages.company_profile.csr_env_text') || 'Implementing ISO 14001 standards, land reclamation, and renewable energy in mining operations to minimize our carbon footprint.'}</p>
                            ...
                            <div className="rounded-3xl bg-white p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-stone-100 border-l-4 border-l-blue-500 flex gap-8 items-center flex-grow">
                                <div className="flex-shrink-0 h-20 w-20 rounded-full bg-blue-50 flex items-center justify-center border border-blue-100">
                                ...
                                <div className="flex-grow">
                                    ...
                                    <p className="text-stone-600 text-lg leading-relaxed mb-4">{t('pages.company_profile.csr_com_text') || 'Building schools, hospitals, and infrastructure for the communities in Nabire, Central Papua, ensuring mutual prosperity.'}</p>
                            ...
                            <div className="rounded-3xl bg-white p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-stone-100 border-l-4 border-l-rose-500 flex gap-8 items-center flex-grow">
                                <div className="flex-shrink-0 h-20 w-20 rounded-full bg-rose-50 flex items-center justify-center border border-rose-100">
                                ...
                                <div className="flex-grow">
                                    ...
                                    <p className="text-stone-600 text-lg leading-relaxed mb-4">{t('pages.company_profile.csr_edu_text') || 'Providing scholarships and funding local health clinics to improve the quality of life for future generations.'}</p>
                ...
                <div 
                    className="flex flex-col min-h-[297mm] print:h-[297mm] print:break-before-page relative overflow-hidden"
                    style={{
                ...
                >
                    ...
                    <div className="flex-grow flex flex-col items-center justify-center relative z-10 text-center p-16">
                        ...
                        {/* Contact Us Title */}
                        <h2 className="text-4xl font-bold text-amber-500 mb-16 tracking-wider uppercase">
                            CONTACT US
                        </h2>
